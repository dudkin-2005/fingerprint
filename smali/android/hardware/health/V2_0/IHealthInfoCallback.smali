...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/health/V2_0/IHealthInfoCallback;
    ...
    .line 15
    check-cast v1, Landroid/hardware/health/V2_0/IHealthInfoCallback;

    return-object v1

    .line 18
    :cond_1
    new-instance v1, Landroid/hardware/health/V2_0/IHealthInfoCallback$Proxy;

    invoke-direct {v1, p0}, Landroid/hardware/health/V2_0/IHealthInfoCallback$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 21
    :try_start_0
    invoke-interface {v1}, Landroid/hardware/health/V2_0/IHealthInfoCallback;->interfaceChain()Ljava/util/ArrayList;
