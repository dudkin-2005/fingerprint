...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/contexthub/V1_0/IContexthub;
    ...
    .line 15
    check-cast v1, Landroid/hardware/contexthub/V1_0/IContexthub;

    return-object v1

    .line 18
    :cond_1
    new-instance v1, Landroid/hardware/contexthub/V1_0/IContexthub$Proxy;

    invoke-direct {v1, p0}, Landroid/hardware/contexthub/V1_0/IContexthub$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 21
    :try_start_0
    invoke-interface {v1}, Landroid/hardware/contexthub/V1_0/IContexthub;->interfaceChain()Ljava/util/ArrayList;
