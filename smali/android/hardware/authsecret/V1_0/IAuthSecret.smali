...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/authsecret/V1_0/IAuthSecret;
    ...
    .line 15
    check-cast v1, Landroid/hardware/authsecret/V1_0/IAuthSecret;

    return-object v1

    .line 18
    :cond_1
    new-instance v1, Landroid/hardware/authsecret/V1_0/IAuthSecret$Proxy;

    invoke-direct {v1, p0}, Landroid/hardware/authsecret/V1_0/IAuthSecret$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 21
    :try_start_0
    invoke-interface {v1}, Landroid/hardware/authsecret/V1_0/IAuthSecret;->interfaceChain()Ljava/util/ArrayList;
    ...
    .line 22
    const-string v3, "android.hardware.authsecret@1.0::IAuthSecret"
