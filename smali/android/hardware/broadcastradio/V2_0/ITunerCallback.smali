...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/broadcastradio/V2_0/ITunerCallback;
    ...
    .line 15
    check-cast v1, Landroid/hardware/broadcastradio/V2_0/ITunerCallback;

    return-object v1

    .line 18
    :cond_1
    new-instance v1, Landroid/hardware/broadcastradio/V2_0/ITunerCallback$Proxy;

    invoke-direct {v1, p0}, Landroid/hardware/broadcastradio/V2_0/ITunerCallback$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 21
    :try_start_0
    invoke-interface {v1}, Landroid/hardware/broadcastradio/V2_0/ITunerCallback;->interfaceChain()Ljava/util/ArrayList;
    ...
    .line 22
    const-string v3, "android.hardware.broadcastradio@2.0::ITunerCallback"
