...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/broadcastradio/V2_0/ICloseHandle;
    ...
    .line 15
    check-cast v1, Landroid/hardware/broadcastradio/V2_0/ICloseHandle;

    return-object v1

    .line 18
    :cond_1
    new-instance v1, Landroid/hardware/broadcastradio/V2_0/ICloseHandle$Proxy;

    invoke-direct {v1, p0}, Landroid/hardware/broadcastradio/V2_0/ICloseHandle$Proxy;-><init>(Landroid/os/IHwBinder;)V

    .line 21
    :try_start_0
    invoke-interface {v1}, Landroid/hardware/broadcastradio/V2_0/ICloseHandle;->interfaceChain()Ljava/util/ArrayList;
