...
.method public constructor <init>(Landroid/os/Handler;Landroid/net/util/InterfaceParams;Landroid/util/LocalLog;)V
    ...
    .line 77
    new-instance p3, Landroid/net/ip/ConnectivityPacketTracker$PacketListener;

    invoke-direct {p3, p0, p1, p2}, Landroid/net/ip/ConnectivityPacketTracker$PacketListener;-><init>(Landroid/net/ip/ConnectivityPacketTracker;Landroid/os/Handler;Landroid/net/util/InterfaceParams;)V

    iput-object p3, p0, Landroid/net/ip/ConnectivityPacketTracker;->mPacketListener:Landroid/net/util/PacketReader;
...
.method static synthetic access$000(Landroid/net/ip/ConnectivityPacketTracker;)Ljava/lang/String;
    ...
    .line 58
    iget-object p0, p0, Landroid/net/ip/ConnectivityPacketTracker;->mDisplayName:Ljava/lang/String;
...
.method static synthetic access$100(Landroid/net/ip/ConnectivityPacketTracker;)Landroid/util/LocalLog;
    ...
    .line 58
    iget-object p0, p0, Landroid/net/ip/ConnectivityPacketTracker;->mLog:Landroid/util/LocalLog;
...
.method static synthetic access$200(Landroid/net/ip/ConnectivityPacketTracker;)Z
    ...
    .line 58
    iget-boolean p0, p0, Landroid/net/ip/ConnectivityPacketTracker;->mRunning:Z
...
.method static synthetic access$300(Landroid/net/ip/ConnectivityPacketTracker;)Ljava/lang/String;
    ...
    .line 58
    iget-object p0, p0, Landroid/net/ip/ConnectivityPacketTracker;->mTag:Ljava/lang/String;
...
.method public start(Ljava/lang/String;)V
    ...
    .line 83
    iget-object p1, p0, Landroid/net/ip/ConnectivityPacketTracker;->mPacketListener:Landroid/net/util/PacketReader;

    invoke-virtual {p1}, Landroid/net/util/PacketReader;->start()V
