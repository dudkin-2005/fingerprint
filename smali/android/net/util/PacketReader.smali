...
.method protected constructor <init>(Landroid/os/Handler;I)V
    ...
    .line 92
    iget-object p1, p0, Landroid/net/util/PacketReader;->mHandler:Landroid/os/Handler;
    ...
    iput-object p1, p0, Landroid/net/util/PacketReader;->mQueue:Landroid/os/MessageQueue;
    ...
    iput-object p1, p0, Landroid/net/util/PacketReader;->mPacket:[B
...
.method private handleInput()Z
    ...
    const-string v1, "Socket closed, exiting"

    const/4 v2, 0x0

    invoke-virtual {p0, v1, v2}, Landroid/net/util/PacketReader;->logError(Ljava/lang/String;Ljava/lang/Exception;)V
