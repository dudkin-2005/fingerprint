...
.method public constructor <init>(Landroid/net/apf/ApfFilter;Ljava/io/FileDescriptor;)V
    ...
    iput-object p1, p0, Landroid/net/apf/ApfFilter$ReceiveThread;->mPacket:[B
    ...
    .line 176
    new-instance p1, Landroid/net/metrics/ApfStats;

    invoke-direct {p1}, Landroid/net/metrics/ApfStats;-><init>()V

    iput-object p1, p0, Landroid/net/apf/ApfFilter$ReceiveThread;->mStats:Landroid/net/metrics/ApfStats;
...
.method private logStats()V
    ...
    invoke-static {v2, v0, v1}, Landroid/net/apf/ApfFilter;->access$500(Landroid/net/apf/ApfFilter;J)V
...
.method private updateStats(Landroid/net/apf/ApfFilter$ProcessRaResult;)V
    ...
    .line 228
    :pswitch_0
    iget-object p1, p0, Landroid/net/apf/ApfFilter$ReceiveThread;->mStats:Landroid/net/metrics/ApfStats;

    iget v0, p1, Landroid/net/metrics/ApfStats;->programUpdates:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p1, Landroid/net/metrics/ApfStats;->programUpdates:I
    ...
    iget v0, p1, Landroid/net/metrics/ApfStats;->matchingRas:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p1, Landroid/net/metrics/ApfStats;->matchingRas:I
    ...
    iget v0, p1, Landroid/net/metrics/ApfStats;->zeroLifetimeRas:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p1, Landroid/net/metrics/ApfStats;->zeroLifetimeRas:I
    ...
    iget v0, p1, Landroid/net/metrics/ApfStats;->parseErrors:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p1, Landroid/net/metrics/ApfStats;->parseErrors:I
    ...
    iget v0, p1, Landroid/net/metrics/ApfStats;->droppedRas:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p1, Landroid/net/metrics/ApfStats;->droppedRas:I
