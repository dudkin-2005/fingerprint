...
.method constructor <init>(I)V
    ...
    invoke-direct {p0, p1}, Landroid/net/apf/ApfGenerator;->requireApfVersion(I)V
...
.method static synthetic access$000(Landroid/net/apf/ApfGenerator;)Ljava/util/HashMap;
    ...
    .line 30
    iget-object p0, p0, Landroid/net/apf/ApfGenerator;->mLabels:Ljava/util/HashMap;
...
.method static synthetic access$100(Landroid/net/apf/ApfGenerator;)Landroid/net/apf/ApfGenerator$Instruction;
    ...
    .line 30
    iget-object p0, p0, Landroid/net/apf/ApfGenerator;->mDropLabel:Landroid/net/apf/ApfGenerator$Instruction;
...
.method static synthetic access$200(Landroid/net/apf/ApfGenerator;)Landroid/net/apf/ApfGenerator$Instruction;
    ...
    .line 30
    iget-object p0, p0, Landroid/net/apf/ApfGenerator;->mPassLabel:Landroid/net/apf/ApfGenerator$Instruction;
...
.method private addInstruction(Landroid/net/apf/ApfGenerator$Instruction;)V
    ...
    const-string v0, "Program already generated"
...
.method public addJumpIfBytesNotEqual(Landroid/net/apf/ApfGenerator$Register;[BLjava/lang/String;)Landroid/net/apf/ApfGenerator;
    ...
    .line 760
    :cond_0
    new-instance p1, Landroid/net/apf/ApfGenerator$IllegalInstructionException;

    const-string p2, "JNEBS fails with R1"

    invoke-direct {p1, p2}, Landroid/net/apf/ApfGenerator$IllegalInstructionException;-><init>(Ljava/lang/String;)V
...
.method public addLoadFromMemory(Landroid/net/apf/ApfGenerator$Register;I)Landroid/net/apf/ApfGenerator;
    ...
    .line 780
    sget-object p1, Landroid/net/apf/ApfGenerator$ExtendedOpcodes;->LDM:Landroid/net/apf/ApfGenerator$ExtendedOpcodes;

    iget p1, p1, Landroid/net/apf/ApfGenerator$ExtendedOpcodes;->value:I
    ...
    const-string v1, "illegal memory slot number: "
...
.method public addMove(Landroid/net/apf/ApfGenerator$Register;)Landroid/net/apf/ApfGenerator;
    ...
    .line 836
    sget-object p1, Landroid/net/apf/ApfGenerator$ExtendedOpcodes;->MOVE:Landroid/net/apf/ApfGenerator$ExtendedOpcodes;
...
.method public addNeg(Landroid/net/apf/ApfGenerator$Register;)Landroid/net/apf/ApfGenerator;
    ...
    .line 815
    sget-object p1, Landroid/net/apf/ApfGenerator$ExtendedOpcodes;->NEG:Landroid/net/apf/ApfGenerator$ExtendedOpcodes;
...
.method public addNot(Landroid/net/apf/ApfGenerator$Register;)Landroid/net/apf/ApfGenerator;
    ...
    .line 805
    sget-object p1, Landroid/net/apf/ApfGenerator$ExtendedOpcodes;->NOT:Landroid/net/apf/ApfGenerator$ExtendedOpcodes;
...
.method public addStoreToMemory(Landroid/net/apf/ApfGenerator$Register;I)Landroid/net/apf/ApfGenerator;
    ...
    .line 795
    sget-object p1, Landroid/net/apf/ApfGenerator$ExtendedOpcodes;->STM:Landroid/net/apf/ApfGenerator$ExtendedOpcodes;
...
.method public generate()[B
    ...
    .line 917
    iget-object v3, p0, Landroid/net/apf/ApfGenerator;->mDropLabel:Landroid/net/apf/ApfGenerator$Instruction;

    add-int/lit8 v4, v2, 0x1

    iput v4, v3, Landroid/net/apf/ApfGenerator$Instruction;->offset:I

    .line 918
    iget-object v3, p0, Landroid/net/apf/ApfGenerator;->mPassLabel:Landroid/net/apf/ApfGenerator$Instruction;

    iput v2, v3, Landroid/net/apf/ApfGenerator$Instruction;->offset:I
    ...
    .line 923
    iget-object v4, p0, Landroid/net/apf/ApfGenerator;->mInstructions:Ljava/util/ArrayList;
    ...
    check-cast v5, Landroid/net/apf/ApfGenerator$Instruction;

    .line 924
    invoke-virtual {v5}, Landroid/net/apf/ApfGenerator$Instruction;->shrink()Z
    ...
    .line 932
    invoke-virtual {v2, v0}, Landroid/net/apf/ApfGenerator$Instruction;->generate([B)V
