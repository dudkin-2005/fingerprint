...
.method private constructor <init>(Landroid/content/Context;Lcom/android/internal/util/StateMachine;Ljava/lang/String;)V
    ...
    .line 240
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mStoppedState:Lcom/android/internal/util/State;

    invoke-virtual {p0, p1}, Landroid/net/dhcp/DhcpClient;->addState(Lcom/android/internal/util/State;)V

    .line 241
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mDhcpState:Lcom/android/internal/util/State;

    invoke-virtual {p0, p1}, Landroid/net/dhcp/DhcpClient;->addState(Lcom/android/internal/util/State;)V

    .line 242
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mDhcpInitState:Lcom/android/internal/util/State;

    iget-object p2, p0, Landroid/net/dhcp/DhcpClient;->mDhcpState:Lcom/android/internal/util/State;

    invoke-virtual {p0, p1, p2}, Landroid/net/dhcp/DhcpClient;->addState(Lcom/android/internal/util/State;Lcom/android/internal/util/State;)V

    .line 243
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mDhcpRapidCommitInitState:Lcom/android/internal/util/State;
    ...
    .line 244
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mWaitBeforeStartState:Lcom/android/internal/util/State;
    ...
    .line 245
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mRapidCommitWaitBeforeStartState:Lcom/android/internal/util/State;
    ...
    .line 246
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mDhcpSelectingState:Lcom/android/internal/util/State;
    ...
    .line 247
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mDhcpRequestingState:Lcom/android/internal/util/State;
    ...
    .line 248
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mDhcpHaveLeaseState:Lcom/android/internal/util/State;
    ...
    .line 249
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mConfiguringInterfaceState:Lcom/android/internal/util/State;

    iget-object p2, p0, Landroid/net/dhcp/DhcpClient;->mDhcpHaveLeaseState:Lcom/android/internal/util/State;

    invoke-virtual {p0, p1, p2}, Landroid/net/dhcp/DhcpClient;->addState(Lcom/android/internal/util/State;Lcom/android/internal/util/State;)V

    .line 250
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mDhcpBoundState:Lcom/android/internal/util/State;
    ...
    .line 251
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mWaitBeforeRenewalState:Lcom/android/internal/util/State;
    ...
    .line 252
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mDhcpRenewingState:Lcom/android/internal/util/State;
    ...
    .line 253
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mDhcpRebindingState:Lcom/android/internal/util/State;
    ...
    .line 254
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mDhcpInitRebootState:Lcom/android/internal/util/State;
    ...
    .line 255
    iget-object p1, p0, Landroid/net/dhcp/DhcpClient;->mDhcpRebootingState:Lcom/android/internal/util/State;
    ...
    invoke-virtual {p0, p1}, Landroid/net/dhcp/DhcpClient;->setInitialState(Lcom/android/internal/util/State;)V
    ...
    iput-object p1, p0, Landroid/net/dhcp/DhcpClient;->mRandom:Ljava/util/Random;
    ...
    invoke-direct {p0, p1, p2}, Landroid/net/dhcp/DhcpClient;->makeWakeupMessage(Ljava/lang/String;I)Lcom/android/internal/util/WakeupMessage;

    move-result-object p1

    iput-object p1, p0, Landroid/net/dhcp/DhcpClient;->mKickAlarm:Lcom/android/internal/util/WakeupMessage;
    ...
    iput-object p1, p0, Landroid/net/dhcp/DhcpClient;->mTimeoutAlarm:Lcom/android/internal/util/WakeupMessage;
    ...
    iput-object p1, p0, Landroid/net/dhcp/DhcpClient;->mRenewAlarm:Lcom/android/internal/util/WakeupMessage;

    .line 267
    const-string p1, "REBIND"
    ...
    iput-object p1, p0, Landroid/net/dhcp/DhcpClient;->mRebindAlarm:Lcom/android/internal/util/WakeupMessage;
    ...
    iput-object p1, p0, Landroid/net/dhcp/DhcpClient;->mExpiryAlarm:Lcom/android/internal/util/WakeupMessage;
...
.method private acceptDhcpResults(Landroid/net/DhcpResults;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Landroid/net/dhcp/DhcpClient;->mDhcpLease:Landroid/net/DhcpResults;
...
.method static synthetic access$100(Landroid/net/dhcp/DhcpClient;)Ljava/io/FileDescriptor;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mPacketSock:Ljava/io/FileDescriptor;
...
.method static synthetic access$1000(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/State;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mDhcpRapidCommitInitState:Lcom/android/internal/util/State;
...
.method static synthetic access$1400(Landroid/net/dhcp/DhcpClient;)Landroid/net/DhcpResults;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mOffer:Landroid/net/DhcpResults;
...
.method static synthetic access$1500(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/State;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mDhcpRequestingState:Lcom/android/internal/util/State;
...
.method static synthetic access$1700(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/State;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mConfiguringInterfaceState:Lcom/android/internal/util/State;
...
.method static synthetic access$2100(Landroid/net/dhcp/DhcpClient;)Landroid/net/dhcp/DhcpClient$ReceiveThread;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mReceiveThread:Landroid/net/dhcp/DhcpClient$ReceiveThread;
...
.method static synthetic access$2300(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/State;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mStoppedState:Lcom/android/internal/util/State;
...
.method static synthetic access$2400(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/WakeupMessage;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mKickAlarm:Lcom/android/internal/util/WakeupMessage;
...
.method static synthetic access$2500(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/WakeupMessage;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mTimeoutAlarm:Lcom/android/internal/util/WakeupMessage;
...
.method static synthetic access$2600(Landroid/net/dhcp/DhcpClient;)Ljava/util/Random;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mRandom:Ljava/util/Random;
...
.method static synthetic access$2800(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/WakeupMessage;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mRenewAlarm:Lcom/android/internal/util/WakeupMessage;
...
.method static synthetic access$2900(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/WakeupMessage;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mRebindAlarm:Lcom/android/internal/util/WakeupMessage;
...
.method static synthetic access$3000(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/WakeupMessage;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mExpiryAlarm:Lcom/android/internal/util/WakeupMessage;
...
.method static synthetic access$3100(Landroid/net/dhcp/DhcpClient;)Landroid/net/DhcpResults;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mDhcpLease:Landroid/net/DhcpResults;
...
.method static synthetic access$3200(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/State;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mDhcpBoundState:Lcom/android/internal/util/State;
...
.method static synthetic access$3600(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/State;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mWaitBeforeRenewalState:Lcom/android/internal/util/State;
...
.method static synthetic access$3700(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/State;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mDhcpRenewingState:Lcom/android/internal/util/State;
...
.method static synthetic access$3800(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/State;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mDhcpRebindingState:Lcom/android/internal/util/State;
...
.method static synthetic access$3900(Landroid/net/dhcp/DhcpClient;)Ljava/io/FileDescriptor;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mUdpSock:Ljava/io/FileDescriptor;
...
.method static synthetic access$500(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/StateMachine;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mController:Lcom/android/internal/util/StateMachine;
...
.method static synthetic access$600(Landroid/net/dhcp/DhcpClient;)Z
    ...
    .line 87
    iget-boolean p0, p0, Landroid/net/dhcp/DhcpClient;->mRegisteredForPreDhcpNotification:Z
...
.method static synthetic access$700(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/State;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mWaitBeforeStartState:Lcom/android/internal/util/State;
...
.method static synthetic access$800(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/State;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mDhcpInitState:Lcom/android/internal/util/State;
...
.method static synthetic access$900(Landroid/net/dhcp/DhcpClient;)Lcom/android/internal/util/State;
    ...
    .line 87
    iget-object p0, p0, Landroid/net/dhcp/DhcpClient;->mRapidCommitWaitBeforeStartState:Lcom/android/internal/util/State;
...
.method private connectUdpSock(Ljava/net/Inet4Address;)Z
    ...
    const-string v1, "Error connecting UDP socket"
...
.method private scheduleLeaseTimers()V
    ...
    const-string v8, "Scheduling renewal in "
    ...
    const-string v4, "Scheduling rebind in "
    ...
    const-string v4, "Scheduling expiry in "
...
.method private sendRequestPacket(Ljava/net/Inet4Address;Ljava/net/Inet4Address;Ljava/net/Inet4Address;Ljava/net/Inet4Address;)Z
    ...
    .line 463
    invoke-direct {p0, v1, p1, v0, p4}, Landroid/net/dhcp/DhcpClient;->transmitPacket(Ljava/nio/ByteBuffer;Ljava/lang/String;ILjava/net/Inet4Address;)Z
...
.method private transmitPacket(Ljava/nio/ByteBuffer;Ljava/lang/String;ILjava/net/Inet4Address;)Z
    ...
    sget-object p3, Landroid/net/dhcp/DhcpPacket;->INADDR_BROADCAST:Ljava/net/Inet4Address;

    invoke-virtual {p4, p3}, Ljava/net/Inet4Address;->equals(Ljava/lang/Object;)Z
    ...
    .line 419
    iget-object p2, p0, Landroid/net/dhcp/DhcpClient;->mUdpSock:Ljava/io/FileDescriptor;

    const/16 p3, 0x43

    invoke-static {p2, p1, v1, p4, p3}, Landroid/system/Os;->sendto(Ljava/io/FileDescriptor;Ljava/nio/ByteBuffer;ILjava/net/InetAddress;I)I
    ...
    const-string p4, "Unicasting %s to %s"
    ...
    .line 424
    invoke-static {p2}, Landroid/system/Os;->getpeername(Ljava/io/FileDescriptor;)Ljava/net/SocketAddress;
    ...
    invoke-static {p2, p1}, Landroid/system/Os;->write(Ljava/io/FileDescriptor;Ljava/nio/ByteBuffer;)I
    :try_end_0
    .catch Landroid/system/ErrnoException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string p3, "Can\'t send packet: "
...
.method public isValidPacket(Landroid/net/dhcp/DhcpPacket;)Z
    ...
    iget v0, p0, Landroid/net/dhcp/DhcpClient;->mTransactionId:I
