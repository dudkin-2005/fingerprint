...
.method public startDream(Landroid/os/Binder;Landroid/content/ComponentName;ZZILandroid/os/PowerManager$WakeLock;)V
    ...
    invoke-virtual {v9, v11}, Lcom/android/server/dreams/DreamController;->stopDream(Z)V
    ...
    const-string v3, "Starting dream: name="
    ...
    const-string v3, "Unable to bind dream service: "
    ...
    iput-boolean v11, v0, Lcom/android/server/dreams/DreamController$DreamRecord;->mBound:Z
...
.method public stopDream(Z)V
    ...
    iput-boolean v0, p1, Lcom/android/server/dreams/DreamController$DreamRecord;->mWakingGently:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    iget-object v0, p0, Lcom/android/server/dreams/DreamController;->mStopStubbornDreamRunnable:Ljava/lang/Runnable;
    ...
    .line 206
    iget-boolean v4, p1, Lcom/android/server/dreams/DreamController$DreamRecord;->mCanDoze:Z
    ...
    .line 205
    :goto_1
    invoke-static {v3, v4}, Lcom/android/internal/logging/MetricsLogger;->hidden(Landroid/content/Context;I)V
    ...
    iget-wide v7, p0, Lcom/android/server/dreams/DreamController;->mDreamStartTime:J
    ...
    .line 214
    iget-boolean v3, p1, Lcom/android/server/dreams/DreamController$DreamRecord;->mSentStartBroadcast:Z
    ...
    .line 218
    :cond_5
    iget-object v3, p1, Lcom/android/server/dreams/DreamController$DreamRecord;->mService:Landroid/service/dreams/IDreamService;
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    :goto_4
    :try_start_6
    iput-object v0, p1, Lcom/android/server/dreams/DreamController$DreamRecord;->mService:Landroid/service/dreams/IDreamService;

    .line 236
    :cond_6
    iget-boolean v0, p1, Lcom/android/server/dreams/DreamController$DreamRecord;->mBound:Z
    ...
    iget-object v3, p1, Lcom/android/server/dreams/DreamController$DreamRecord;->mToken:Landroid/os/Binder;
