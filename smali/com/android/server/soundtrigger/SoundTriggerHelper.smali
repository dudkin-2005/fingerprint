...
.method constructor <init>(Landroid/content/Context;)V
    ...
    const-string v3, "listModules status="

    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v2, ", # of modules="
...
.method private forceStopAndUnloadModelLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Ljava/lang/Exception;Ljava/util/Iterator;)V
    ...
    invoke-virtual {p2, v0}, Landroid/hardware/soundtrigger/SoundTriggerModule;->stopRecognition(I)I
    ...
    invoke-virtual {p2, v0}, Landroid/hardware/soundtrigger/SoundTriggerModule;->unloadSoundModel(I)I
    ...
    const-string v0, "Failed to unload model "
...
.method private getKeyphraseIdFromEvent(Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;)I
    ...
    const-string v1, "Null RecognitionEvent received."
    ...
    const-string v1, "Invalid keyphrase recognition event!"
...
.method private onGenericRecognitionSuccessLocked(Landroid/hardware/soundtrigger/SoundTrigger$GenericRecognitionEvent;)V
    ...
    const-string v2, "Generic recognition event: Null RecognitionConfig for model handle: "
    ...
    invoke-direct {p0, v0, p1, v2}, Lcom/android/server/soundtrigger/SoundTriggerHelper;->updateRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
...
.method private onKeyphraseRecognitionSuccessLocked(Landroid/hardware/soundtrigger/SoundTrigger$KeyphraseRecognitionEvent;)V
    ...
    const-string v0, "Received onRecognition event without callback for keyphrase model."
    ...
    const-string v3, "RemoteException in onKeyphraseDetected"
    ...
    invoke-direct {p0, v1, p1, v2}, Lcom/android/server/soundtrigger/SoundTriggerHelper;->updateRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
    ...
    .line 774
    invoke-direct {p0, v1, p1}, Lcom/android/server/soundtrigger/SoundTriggerHelper;->forceStopAndUnloadModelLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Ljava/lang/Exception;)V
...
.method private startRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Z)I
    ...
    const-string v0, "RemoteException in onError"
    ...
    const-string v0, "RemoteException in onRecognitionResumed"
    ...
    const-string/jumbo p2, "sth_start_recognition_error"
...
.method private stopRecognitionLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;Z)I
    ...
    const-string v0, "RemoteException in onRecognitionPaused"
...
.method private tryStopAndUnloadLocked(Lcom/android/server/soundtrigger/SoundTriggerHelper$ModelData;ZZ)I
    ...
    const-string/jumbo p3, "stopRecognition failed: "
    ...
    invoke-static {p2, p3, v0}, Lcom/android/internal/logging/MetricsLogger;->count(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    const-string/jumbo p3, "unloadSoundModel call failed with "
...
.method unloadGenericSoundModel(Ljava/util/UUID;)I
    ...
    const-string v4, "Unload: Given generic model is not loaded:"
