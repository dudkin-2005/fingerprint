...
.method addDuck(Landroid/media/AudioPlaybackConfiguration;Z)V
    ...
    .line 726
    :goto_0
    invoke-virtual {p1, v1, p2}, Landroid/media/PlayerProxy;->applyVolumeShaper(Landroid/media/VolumeShaper$Configuration;Landroid/media/VolumeShaper$Operation;)V
    ...
    iget v0, p0, Lcom/android/server/audio/PlaybackActivityMonitor$DuckingManager$DuckedApp;->mUid:I
...
.method removeUnduckAll(Ljava/util/HashMap;)V
    ...
    sget-object v4, Landroid/media/VolumeShaper$Operation;->REVERSE:Landroid/media/VolumeShaper$Operation;
