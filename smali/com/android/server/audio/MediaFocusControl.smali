...
.method private pushBelowLockedFocusOwners(Lcom/android/server/audio/FocusRequester;)I
    ...
    const-string v1, "No exclusive focus owner found in propagateFocusLossFromGain_syncAf()"
...
.method private removeFocusStackEntry(Ljava/lang/String;ZZ)V
    ...
    const-string v2, "AudioFocus  removeFocusStackEntry(): removing entry for "
...
.method notifyExtFocusPolicyFocusAbandon_syncAf(Landroid/media/AudioFocusInfo;)Z
    ...
    const-string v2, "Can\'t call notifyAudioFocusAbandon() on IAudioPolicyCallback "
...
.method notifyExtFocusPolicyFocusRequest_syncAf(Landroid/media/AudioFocusInfo;Landroid/media/IAudioFocusDispatcher;Landroid/os/IBinder;)Z
    ...
    iput-wide v5, p0, Lcom/android/server/audio/MediaFocusControl;->mExtFocusChangeCounter:J
    ...
    invoke-direct {v5, p0, p3}, Lcom/android/server/audio/MediaFocusControl$AudioFocusDeathHandler;-><init>(Lcom/android/server/audio/MediaFocusControl;Landroid/os/IBinder;)V
    ...
    invoke-interface {v1, p1, v2}, Landroid/media/audiopolicy/IAudioPolicyCallback;->notifyAudioFocusRequest(Landroid/media/AudioFocusInfo;I)V
    :try_end_1
...
.method protected requestAudioFocus(Landroid/media/AudioAttributes;ILandroid/os/IBinder;Landroid/media/IAudioFocusDispatcher;Ljava/lang/String;Ljava/lang/String;IIZ)I
    ...
    .line 759
    :try_start_1
    invoke-interface {v10, v8, v12}, Landroid/os/IBinder;->linkToDeath(Landroid/os/IBinder$DeathRecipient;I)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 773
    invoke-interface {v10, v8, v12}, Landroid/os/IBinder;->unlinkToDeath(Landroid/os/IBinder$DeathRecipient;I)Z
    ...
    :cond_b
    :goto_3
    invoke-direct {v0, v11, v12, v12}, Lcom/android/server/audio/MediaFocusControl;->removeFocusStackEntry(Ljava/lang/String;ZZ)V

    .line 790
    new-instance v12, Lcom/android/server/audio/FocusRequester;
    ...
    invoke-direct {v0, v13, v14, v1}, Lcom/android/server/audio/MediaFocusControl;->propagateFocusLossFromGain_syncAf(ILcom/android/server/audio/FocusRequester;Z)V
    ...
    invoke-virtual {v14, v1}, Lcom/android/server/audio/FocusRequester;->handleFocusGainFromRequest(I)V
