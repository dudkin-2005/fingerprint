...
.method private sendMessage(Landroid/os/Message;)V
    ...
    const-string v0, "Messenger not initialized."
...
.method public callJobFinished(IZLjava/lang/String;)V
    ...
    .line 183
    iget-object p2, p0, Lcom/android/server/content/SyncJobService;->mJobParamsMap:Landroid/util/SparseArray;
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    iput-object p1, p0, Lcom/android/server/content/SyncJobService;->mMessenger:Landroid/os/Messenger;
    ...
    .line 64
    invoke-direct {p0, p1}, Lcom/android/server/content/SyncJobService;->sendMessage(Landroid/os/Message;)V
...
.method public onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    const-string v1, "Got start job message "
...
.method public onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    .line 120
    iget-object v3, v0, Lcom/android/server/content/SyncJobService;->mLogger:Lcom/android/server/content/SyncLogger;
    ...
    iget-object v5, v0, Lcom/android/server/content/SyncJobService;->mLogger:Lcom/android/server/content/SyncLogger;
    ...
    .line 122
    iget-object v2, v0, Lcom/android/server/content/SyncJobService;->mLock:Ljava/lang/Object;
    ...
    .line 124
    iget-object v4, v0, Lcom/android/server/content/SyncJobService;->mJobParamsMap:Landroid/util/SparseArray;

    invoke-virtual {v4, v3}, Landroid/util/SparseArray;->remove(I)V

    .line 126
    iget-object v4, v0, Lcom/android/server/content/SyncJobService;->mJobStartUptimes:Landroid/util/SparseLongArray;
    ...
    const-string v4, " start uptime not found:  params="
    ...
    .line 132
    invoke-direct {v0, v1}, Lcom/android/server/content/SyncJobService;->wtf(Ljava/lang/String;)V
    ...
    iget-object v1, v0, Lcom/android/server/content/SyncJobService;->mStartedSyncs:Landroid/util/SparseBooleanArray;
    ...
    const-string v4, " didn\'t start:  startUptime="

    invoke-virtual {v1, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v9, v10}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v4, " nowUptime="
    ...
    .line 155
    iget-object v1, v0, Lcom/android/server/content/SyncJobService;->mJobStartUptimes:Landroid/util/SparseLongArray;
    ...
    .line 169
    invoke-direct {v0, v1}, Lcom/android/server/content/SyncJobService;->sendMessage(Landroid/os/Message;)V
