...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 86
    iput-boolean v0, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mIsDeviceInPocket:Z
    ...
    .line 94
    iget-object p1, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mContext:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mWindowManager:Landroid/view/WindowManager;
...
.method static synthetic access$1200(Lcom/android/server/policy/ImmersiveModeConfirmation;)Lcom/android/server/policy/ImmersiveModeConfirmation$H;
    ...
    .line 65
    iget-object p0, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mHandler:Lcom/android/server/policy/ImmersiveModeConfirmation$H;
...
.method static synthetic access$300(Lcom/android/server/policy/ImmersiveModeConfirmation;)Landroid/view/WindowManager;
    ...
    .line 65
    iget-object p0, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mWindowManager:Landroid/view/WindowManager;
...
.method static synthetic access$800(Lcom/android/server/policy/ImmersiveModeConfirmation;)Z
    ...
    .line 65
    iget-boolean p0, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mConfirmed:Z
...
.method public immersiveModeChangedLw(Ljava/lang/String;ZZZ)V
    ...
    iget-boolean p1, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mConfirmed:Z

    if-nez p1, :cond_0

    if-eqz p3, :cond_0

    iget-boolean p1, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mVrModeEnabled:Z
    ...
    iget p1, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mLockTaskState:I

    if-eq p1, v1, :cond_0

    iget-boolean p1, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mIsDeviceInPocket:Z

    if-nez p1, :cond_0

    .line 160
    iget-object p1, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mHandler:Lcom/android/server/policy/ImmersiveModeConfirmation$H;

    iget-wide p2, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mShowDelayMs:J

    invoke-virtual {p1, v1, p2, p3}, Lcom/android/server/policy/ImmersiveModeConfirmation$H;->sendEmptyMessageDelayed(IJ)Z
    ...
    invoke-virtual {p1, p2}, Lcom/android/server/policy/ImmersiveModeConfirmation$H;->sendEmptyMessage(I)Z
...
.method onDevicePocketStateChanged(Z)V
    .locals 0

    .line 418
    iput-boolean p1, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mIsDeviceInPocket:Z
...
.method public onPowerKeyDown(ZJZZ)Z
    ...
    .line 171
    iget-object p1, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mClingWindow:Lcom/android/server/policy/ImmersiveModeConfirmation$ClingWindowView;
    ...
    iput-wide p1, p0, Lcom/android/server/policy/ImmersiveModeConfirmation;->mPanicTime:J
