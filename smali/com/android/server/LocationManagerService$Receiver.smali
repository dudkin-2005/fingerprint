...
.method constructor <init>(Lcom/android/server/LocationManagerService;Landroid/location/ILocationListener;Landroid/app/PendingIntent;IILjava/lang/String;Landroid/os/WorkSource;Z)V
    ...
    .line 814
    new-instance p2, Lcom/android/server/LocationManagerService$Identity;

    invoke-direct {p2, p5, p4, p6}, Lcom/android/server/LocationManagerService$Identity;-><init>(IILjava/lang/String;)V

    iput-object p2, p0, Lcom/android/server/LocationManagerService$Receiver;->mIdentity:Lcom/android/server/LocationManagerService$Identity;
    ...
    iget-object p1, p0, Lcom/android/server/LocationManagerService$Receiver;->mIdentity:Lcom/android/server/LocationManagerService$Identity;

    iget p1, p1, Lcom/android/server/LocationManagerService$Identity;->mUid:I

    iget-object p2, p0, Lcom/android/server/LocationManagerService$Receiver;->mIdentity:Lcom/android/server/LocationManagerService$Identity;

    iget-object p2, p2, Lcom/android/server/LocationManagerService$Identity;->mPackageName:Ljava/lang/String;

    invoke-direct {p7, p1, p2}, Landroid/os/WorkSource;-><init>(ILjava/lang/String;)V
...
.method private updateMonitoring(ZZI)Z
    ...
    invoke-static {p1}, Lcom/android/server/LocationManagerService;->access$1500(Lcom/android/server/LocationManagerService;)Landroid/app/AppOpsManager;

    move-result-object p1

    iget-object p2, p0, Lcom/android/server/LocationManagerService$Receiver;->mIdentity:Lcom/android/server/LocationManagerService$Identity;

    iget p2, p2, Lcom/android/server/LocationManagerService$Identity;->mUid:I
...
.method public callLocationChangedLocked(Landroid/location/Location;)Z
    ...
    invoke-static {p1}, Lcom/android/server/LocationManagerService;->access$500(Lcom/android/server/LocationManagerService;)Lcom/android/server/LocationManagerService$LocationWorkerHandler;
    ...
    .line 1010
    invoke-static {p1, v0}, Lcom/android/server/LocationManagerService;->access$1600(Lcom/android/server/LocationManagerService;I)Ljava/lang/String;
...
.method public callProviderEnabledLocked(Ljava/lang/String;Z)Z
    ...
    .line 1034
    :try_start_1
    iget-object p2, p0, Lcom/android/server/LocationManagerService$Receiver;->mListener:Landroid/location/ILocationListener;

    invoke-interface {p2, p1}, Landroid/location/ILocationListener;->onProviderEnabled(Ljava/lang/String;)V
    ...
    invoke-interface {p2, p1}, Landroid/location/ILocationListener;->onProviderDisabled(Ljava/lang/String;)V
    ...
    .line 1053
    invoke-static {p1, p2}, Lcom/android/server/LocationManagerService;->access$1600(Lcom/android/server/LocationManagerService;I)Ljava/lang/String;
...
.method public updateMonitoring(Z)V
    ...
    iget-object v4, v3, Lcom/android/server/LocationManagerService$UpdateRecord;->mProvider:Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v0, v2}, Lcom/android/server/LocationManagerService$Receiver;->updateMonitoring(ZZI)Z
