...
.method public constructor <init>(Lcom/android/server/job/controllers/IdleController;)V
    ...
    .line 115
    iget-object p1, p1, Lcom/android/server/job/controllers/IdleController;->mContext:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->mAlarm:Landroid/app/AlarmManager;

    .line 119
    const/4 p1, 0x0

    iput-boolean p1, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->mIdle:Z

    .line 120
    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->mScreenOn:Z

    .line 121
    iput-boolean p1, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->mDockIdle:Z
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 183
    iget-boolean p2, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->mScreenOn:Z
    ...
    .line 191
    iput-boolean v1, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->mDockIdle:Z
    ...
    .line 194
    iget-object p2, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->this$0:Lcom/android/server/job/controllers/IdleController;

    invoke-static {p2}, Lcom/android/server/job/controllers/IdleController;->access$100(Lcom/android/server/job/controllers/IdleController;)J
    ...
    .line 196
    const-string p2, "JobScheduler.Idle"
    ...
    .line 199
    :cond_5
    iget-object v4, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->mAlarm:Landroid/app/AlarmManager;

    const/4 v5, 0x2

    iget-object p1, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->this$0:Lcom/android/server/job/controllers/IdleController;

    .line 200
    invoke-static {p1}, Lcom/android/server/job/controllers/IdleController;->access$200(Lcom/android/server/job/controllers/IdleController;)J

    move-result-wide v8

    const-string v10, "JS idleness"

    iget-object v11, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->mIdleAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;
    ...
    .line 170
    :cond_9
    iget-object p1, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->mAlarm:Landroid/app/AlarmManager;

    iget-object p2, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->mIdleAlarmListener:Landroid/app/AlarmManager$OnAlarmListener;

    invoke-virtual {p1, p2}, Landroid/app/AlarmManager;->cancel(Landroid/app/AlarmManager$OnAlarmListener;)V

    .line 171
    iget-boolean p1, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->mIdle:Z
    ...
    iget-boolean p2, p0, Lcom/android/server/job/controllers/IdleController$IdlenessTracker;->mIdle:Z

    invoke-virtual {p1, p2}, Lcom/android/server/job/controllers/IdleController;->reportNewIdleState(Z)V
