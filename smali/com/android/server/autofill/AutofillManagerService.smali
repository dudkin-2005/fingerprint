...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/os/UserManagerInternal;->getUserRestriction(ILjava/lang/String;)Z
    ...
    const-string v6, "Disabling Autofill for user "
    ...
    .line 187
    :cond_0
    iget-object v4, p0, Lcom/android/server/autofill/AutofillManagerService;->mDisabledUsers:Landroid/util/SparseBooleanArray;
    ...
    .line 190
    :cond_2
    new-instance p1, Lcom/android/server/autofill/-$$Lambda$AutofillManagerService$Yt8ZUfnHlFcXzCNLhvGde5dPRDA;

    invoke-direct {p1, p0}, Lcom/android/server/autofill/-$$Lambda$AutofillManagerService$Yt8ZUfnHlFcXzCNLhvGde5dPRDA;-><init>(Lcom/android/server/autofill/AutofillManagerService;)V

    invoke-virtual {v0, p1}, Landroid/os/UserManagerInternal;->addUserRestrictionsListener(Landroid/os/UserManagerInternal$UserRestrictionsListener;)V
...
.method static synthetic access$1100(Lcom/android/server/autofill/AutofillManagerService;)Landroid/util/SparseBooleanArray;
    ...
    .line 100
    iget-object p0, p0, Lcom/android/server/autofill/AutofillManagerService;->mDisabledUsers:Landroid/util/SparseBooleanArray;
...
.method static synthetic access$200(Lcom/android/server/autofill/AutofillManagerService;)Landroid/util/SparseArray;
    ...
    .line 100
    iget-object p0, p0, Lcom/android/server/autofill/AutofillManagerService;->mServicesCache:Landroid/util/SparseArray;
...
.method static synthetic access$600(Lcom/android/server/autofill/AutofillManagerService;)Landroid/content/Context;
    ...
    .line 100
    iget-object p0, p0, Lcom/android/server/autofill/AutofillManagerService;->mContext:Landroid/content/Context;
...
.method static getWhitelistedCompatModePackages(Ljava/lang/String;)Ljava/util/Map;
    ...
    const-string v7, "Ignoring entry \'"
...
.method public static synthetic lambda$new$0(Lcom/android/server/autofill/AutofillManagerService;ILandroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    .line 193
    iget-object p3, p0, Lcom/android/server/autofill/AutofillManagerService;->mLock:Ljava/lang/Object;
    ...
    const-string v1, "Autofill restriction did not change for user "
    ...
    const-string v2, "Updating Autofill for user "
    ...
    .line 204
    invoke-direct {p0, p1, p2}, Lcom/android/server/autofill/AutofillManagerService;->updateCachedServiceLocked(IZ)V
...
.method private removeCachedServiceLocked(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/autofill/AutofillManagerService$AutofillCompatState;->removeCompatibilityModeRequests(I)V
...
.method destroySessions(ILcom/android/internal/os/IResultReceiver;)V
    ...
    .line 377
    :cond_1
    iget-object p1, p0, Lcom/android/server/autofill/AutofillManagerService;->mServicesCache:Landroid/util/SparseArray;
    ...
    invoke-virtual {v3}, Lcom/android/server/autofill/AutofillManagerServiceImpl;->destroySessionsLocked()V
    ...
    invoke-interface {p2, v2, p1}, Lcom/android/internal/os/IResultReceiver;->send(ILandroid/os/Bundle;)V
    :try_end_1
...
.method getServiceForUserLocked(I)Lcom/android/server/autofill/AutofillManagerServiceImpl;
    ...
    .line 341
    iget-object v1, v0, Lcom/android/server/autofill/AutofillManagerService;->mServicesCache:Landroid/util/SparseArray;
    ...
    .line 343
    new-instance v1, Lcom/android/server/autofill/AutofillManagerServiceImpl;
    ...
    iget-object v2, v0, Lcom/android/server/autofill/AutofillManagerService;->mUi:Lcom/android/server/autofill/ui/AutoFillUI;

    iget-object v3, v0, Lcom/android/server/autofill/AutofillManagerService;->mAutofillCompatState:Lcom/android/server/autofill/AutofillManagerService$AutofillCompatState;

    iget-object v4, v0, Lcom/android/server/autofill/AutofillManagerService;->mDisabledUsers:Landroid/util/SparseBooleanArray;
    ...
    .line 347
    invoke-direct {v0, v1, v8}, Lcom/android/server/autofill/AutofillManagerService;->addCompatibilityModeRequestsLocked(Lcom/android/server/autofill/AutofillManagerServiceImpl;I)V
...
.method listSessions(ILcom/android/internal/os/IResultReceiver;)V
    ...
    .line 408
    iget-object v5, p0, Lcom/android/server/autofill/AutofillManagerService;->mServicesCache:Landroid/util/SparseArray;
    ...
    invoke-virtual {v5, v1}, Lcom/android/server/autofill/AutofillManagerServiceImpl;->listSessionsLocked(Ljava/util/ArrayList;)V
...
.method public onBootPhase(I)V
    ...
    .line 307
    new-instance p1, Lcom/android/server/autofill/AutofillManagerService$SettingsObserver;

    invoke-static {}, Lcom/android/internal/os/BackgroundThread;->getHandler()Landroid/os/Handler;

    move-result-object v0

    invoke-direct {p1, p0, v0}, Lcom/android/server/autofill/AutofillManagerService$SettingsObserver;-><init>(Lcom/android/server/autofill/AutofillManagerService;Landroid/os/Handler;)V
...
.method setLogLevel(I)V
    ...
    :goto_0
    iget-object p1, p0, Lcom/android/server/autofill/AutofillManagerService;->mLock:Ljava/lang/Object;
