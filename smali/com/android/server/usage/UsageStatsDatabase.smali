...
.method applyRestoredPayload(Ljava/lang/String;[B)V
    ...
    :try_end_8
    .catchall {:try_start_5 .. :try_end_8} :catchall_ee
    ...
    move-result-object v10
    :try_end_28
    .catchall {:try_start_a .. :try_end_28} :catchall_ec
    ...
    :try_end_2c
    .catch Ljava/io/IOException; {:try_start_28 .. :try_end_2c} :catch_d5
    .catchall {:try_start_28 .. :try_end_2c} :catchall_d1
    ...
    :try_end_c6
    .catch Ljava/io/IOException; {:try_start_2e .. :try_end_c6} :catch_cf
    .catchall {:try_start_2e .. :try_end_c6} :catchall_e3
    ...
    monitor-exit v2
    :try_end_ce
    .catchall {:try_start_c6 .. :try_end_ce} :catchall_f5
    ...
    :try_end_df
    .catchall {:try_start_d8 .. :try_end_df} :catchall_e3
    ...
    monitor-exit v2
    :try_end_f4
    .catchall {:try_start_df .. :try_end_f4} :catchall_f5
...
.method getBackupPayload(Ljava/lang/String;)[B
    ...
    :try_end_1d
    .catchall {:try_start_3 .. :try_end_1d} :catchall_f2
    ...
    :try_end_e0
    .catch Ljava/io/IOException; {:try_start_1e .. :try_end_e0} :catch_e1
    .catchall {:try_start_1e .. :try_end_e0} :catchall_f2
...
.method public queryUsageStats(IJJLcom/android/server/usage/UsageStatsDatabase$StatCombiner;)Ljava/util/List;
    ...
    :try_end_b3
    .catchall {:try_start_d .. :try_end_b3} :catchall_d9
    ...
    :try_end_b8
    .catch Ljava/io/IOException; {:try_start_b3 .. :try_end_b8} :catch_c8
    .catchall {:try_start_b3 .. :try_end_b8} :catchall_d9
    ...
    .catchall {:try_start_bf .. :try_end_c2} :catchall_d9
    ...
    monitor-exit v7
    :try_end_f3
    .catchall {:try_start_cb .. :try_end_f3} :catchall_d9
