...
.method private allocDescriptor(Lcom/android/server/usb/descriptors/ByteStream;)Lcom/android/server/usb/descriptors/UsbDescriptor;
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/usb/descriptors/UsbInterfaceDescriptor;->addEndpointDescriptor(Lcom/android/server/usb/descriptors/UsbEndpointDescriptor;)V
    ...
    const-string v0, "Endpoint Descriptor found with no associated Interface Descriptor!"

    invoke-static {p1, v0}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 157
    new-instance p1, Lcom/android/server/usb/descriptors/UsbDescriptorParser$UsbDescriptorsStreamFormatException;

    const-string v0, "Endpoint Descriptor found with no associated Interface Descriptor!"

    invoke-direct {p1, p0, v0}, Lcom/android/server/usb/descriptors/UsbDescriptorParser$UsbDescriptorsStreamFormatException;-><init>(Lcom/android/server/usb/descriptors/UsbDescriptorParser;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/usb/descriptors/UsbConfigDescriptor;->addInterfaceDescriptor(Lcom/android/server/usb/descriptors/UsbInterfaceDescriptor;)V
    ...
    const-string v0, "Interface Descriptor found with no associated Config Descriptor!"
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/usb/descriptors/UsbDeviceDescriptor;->addConfigDescriptor(Lcom/android/server/usb/descriptors/UsbConfigDescriptor;)V
    ...
    const-string v0, "Config Descriptor found with no associated Device Descriptor!"
    ...
    const-string v3, "Unknown Descriptor len: "
...
.method public parseDescriptors([B)V
    ...
    .line 229
    :try_start_1
    invoke-virtual {p1, v0}, Lcom/android/server/usb/descriptors/UsbDescriptor;->parseRawDescriptors(Lcom/android/server/usb/descriptors/ByteStream;)I

    .line 232
    invoke-virtual {p1, v0}, Lcom/android/server/usb/descriptors/UsbDescriptor;->postParse(Lcom/android/server/usb/descriptors/ByteStream;)V
    :try_end_1
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/usb/descriptors/UsbDescriptor;->setStatus(I)V
    :try_end_2
