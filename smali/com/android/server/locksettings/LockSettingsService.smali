...
.method private removeKeystoreProfileKey(I)V
    ...
    invoke-virtual {v0, v1}, Ljava/security/KeyStore;->deleteEntry(Ljava/lang/String;)V
    :try_end_5c
    .catch Ljava/security/KeyStoreException; {:try_start_28 .. :try_end_5c} :catch_5d
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_28 .. :try_end_5c} :catch_5d
    .catch Ljava/security/cert/CertificateException; {:try_start_28 .. :try_end_5c} :catch_5d
...
.method private setLockCredentialInternal(Ljava/lang/String;ILjava/lang/String;II)V
    ...
    monitor-exit v8
    :try_end_32
    .catchall {:try_start_1f .. :try_end_32} :catchall_150
    ...
    monitor-exit v8
    :try_end_c1
    .catchall {:try_start_a2 .. :try_end_c1} :catchall_145
...
.method private spBasedDoVerifyCredential(Ljava/lang/String;IZJILcom/android/internal/widget/ICheckCredentialProgressCallback;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    monitor-exit v15
    :try_end_34
    .catchall {:try_start_2c .. :try_end_34} :catchall_10d
    ...
    monitor-exit v15
    :try_end_9b
    .catchall {:try_start_41 .. :try_end_9b} :catchall_10d
...
.method private spBasedSetLockCredentialInternalLocked(Ljava/lang/String;ILjava/lang/String;II)V
    ...
    move-result-object v0
    :try_end_2b
    .catch Ljava/io/FileNotFoundException; {:try_start_27 .. :try_end_2b} :catch_36
    .catch Ljava/security/UnrecoverableKeyException; {:try_start_27 .. :try_end_2b} :catch_2c
    .catch Ljava/security/InvalidKeyException; {:try_start_27 .. :try_end_2b} :catch_2c
    .catch Ljava/security/KeyStoreException; {:try_start_27 .. :try_end_2b} :catch_2c
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_27 .. :try_end_2b} :catch_2c
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_27 .. :try_end_2b} :catch_2c
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_27 .. :try_end_2b} :catch_2c
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_27 .. :try_end_2b} :catch_2c
    .catch Ljavax/crypto/BadPaddingException; {:try_start_27 .. :try_end_2b} :catch_2c
    .catch Ljava/security/cert/CertificateException; {:try_start_27 .. :try_end_2b} :catch_2c
...
.method private unlockUser(I[B[B)V
    ...
    :try_end_10
    .catch Landroid/os/RemoteException; {:try_start_b .. :try_end_10} :catch_5a
    ...
    :try_end_4f
    .catch Landroid/os/RemoteException; {:try_start_21 .. :try_end_4f} :catch_51
...
.method private verifyCredential(ILcom/android/server/locksettings/LockSettingsStorage$CredentialHash;Ljava/lang/String;ZJLcom/android/internal/widget/ICheckCredentialProgressCallback;)Lcom/android/internal/widget/VerifyCredentialResponse;
    ...
    :try_end_150
    .catchall {:try_start_146 .. :try_end_150} :catchall_169
    ...
    monitor-exit v1
    :try_end_161
    .catchall {:try_start_156 .. :try_end_161} :catchall_16e
...
.method public resetKeyStore(I)V
    ...
    invoke-static {v0, v7}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_86
    .catch Ljava/security/UnrecoverableKeyException; {:try_start_59 .. :try_end_86} :catch_64
    .catch Ljava/security/InvalidKeyException; {:try_start_59 .. :try_end_86} :catch_64
    .catch Ljava/security/KeyStoreException; {:try_start_59 .. :try_end_86} :catch_64
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_59 .. :try_end_86} :catch_64
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_59 .. :try_end_86} :catch_64
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_59 .. :try_end_86} :catch_64
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_59 .. :try_end_86} :catch_64
    .catch Ljavax/crypto/BadPaddingException; {:try_start_59 .. :try_end_86} :catch_64
    .catch Ljava/security/cert/CertificateException; {:try_start_59 .. :try_end_86} :catch_64
    .catch Ljava/io/IOException; {:try_start_59 .. :try_end_86} :catch_64
...
.method public tieManagedProfileLockIfNecessary(ILjava/lang/String;)V
    ...
    move-result-wide v1
    :try_end_75
    .catch Landroid/os/RemoteException; {:try_start_6d .. :try_end_75} :catch_c2
    ...
    :try_end_b8
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_8b .. :try_end_b8} :catch_b9
    .catch Landroid/os/RemoteException; {:try_start_8b .. :try_end_b8} :catch_b9
...
.method protected tieProfileLockToParent(ILjava/lang/String;)V
    ...
    invoke-virtual {v3, v4}, Ljava/security/KeyStore;->load(Ljava/security/KeyStore$LoadStoreParameter;)V
    :try_end_3d
    .catch Ljava/security/cert/CertificateException; {:try_start_21 .. :try_end_3d} :catch_151
    .catch Ljava/security/UnrecoverableKeyException; {:try_start_21 .. :try_end_3d} :catch_151
    .catch Ljava/io/IOException; {:try_start_21 .. :try_end_3d} :catch_151
    .catch Ljavax/crypto/BadPaddingException; {:try_start_21 .. :try_end_3d} :catch_151
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_21 .. :try_end_3d} :catch_151
    .catch Ljava/security/KeyStoreException; {:try_start_21 .. :try_end_3d} :catch_151
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_21 .. :try_end_3d} :catch_151
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_21 .. :try_end_3d} :catch_151
    .catch Ljava/security/InvalidKeyException; {:try_start_21 .. :try_end_3d} :catch_151
    ...
    move-result-object v7
    :try_end_e4
    .catchall {:try_start_3d .. :try_end_e4} :catchall_13a
    ...
    :try_end_fa
    .catch Ljava/security/cert/CertificateException; {:try_start_e5 .. :try_end_fa} :catch_151
    .catch Ljava/security/UnrecoverableKeyException; {:try_start_e5 .. :try_end_fa} :catch_151
    .catch Ljava/io/IOException; {:try_start_e5 .. :try_end_fa} :catch_151
    .catch Ljavax/crypto/BadPaddingException; {:try_start_e5 .. :try_end_fa} :catch_151
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_e5 .. :try_end_fa} :catch_151
    .catch Ljava/security/KeyStoreException; {:try_start_e5 .. :try_end_fa} :catch_151
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_e5 .. :try_end_fa} :catch_151
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_e5 .. :try_end_fa} :catch_151
    .catch Ljava/security/InvalidKeyException; {:try_start_e5 .. :try_end_fa} :catch_151
    ...
    :try_end_10e
    .catch Ljava/io/IOException; {:try_start_103 .. :try_end_10e} :catch_131
    ...
    throw v2
    :try_end_131
    .catch Ljava/io/IOException; {:try_start_119 .. :try_end_131} :catch_131
    ...
    throw v4
    :try_end_151
    .catch Ljava/security/cert/CertificateException; {:try_start_13b .. :try_end_151} :catch_151
    .catch Ljava/security/UnrecoverableKeyException; {:try_start_13b .. :try_end_151} :catch_151
    .catch Ljava/io/IOException; {:try_start_13b .. :try_end_151} :catch_151
    .catch Ljavax/crypto/BadPaddingException; {:try_start_13b .. :try_end_151} :catch_151
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_13b .. :try_end_151} :catch_151
    .catch Ljava/security/KeyStoreException; {:try_start_13b .. :try_end_151} :catch_151
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_13b .. :try_end_151} :catch_151
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_13b .. :try_end_151} :catch_151
    .catch Ljava/security/InvalidKeyException; {:try_start_13b .. :try_end_151} :catch_151
