...
.method private enableBatterySaverLocked(ZZILjava/lang/String;)V
    ...
    const-string v0, "Manual snooze OFF"

    invoke-direct {p0, p4, v0}, Lcom/android/server/power/batterysaver/BatterySaverStateMachine;->updateSnoozingLocked(ZLjava/lang/String;)V
    ...
    iget-boolean p4, p0, Lcom/android/server/power/batterysaver/BatterySaverStateMachine;->mIsBatteryLevelLow:Z
    ...
    .line 387
    const-string p2, "low_power_sticky"

    invoke-virtual {p0, p2, p1}, Lcom/android/server/power/batterysaver/BatterySaverStateMachine;->putGlobalSetting(Ljava/lang/String;I)V
...
.method private updateSnoozingLocked(ZLjava/lang/String;)V
    ...
    .line 399
    iget-boolean p2, p0, Lcom/android/server/power/batterysaver/BatterySaverStateMachine;->mBatterySaverSnoozing:Z
...
.method public dumpProto(Landroid/util/proto/ProtoOutputStream;J)V
    ...
    iget-boolean v3, p0, Lcom/android/server/power/batterysaver/BatterySaverStateMachine;->mBatterySaverSnoozing:Z
...
.method setSettingsLocked(ZZI)V
    ...
    .line 238
    iget-object p2, p0, Lcom/android/server/power/batterysaver/BatterySaverStateMachine;->mThresholdChangeLogger:Ljava/lang/Runnable;

    const/16 p3, 0x7d0

    invoke-virtual {p0, p2, p3}, Lcom/android/server/power/batterysaver/BatterySaverStateMachine;->runOnBgThreadLazy(Ljava/lang/Runnable;I)V
    ...
    .line 243
    const-string p2, "Global.low_power changed to 1"

    goto :goto_3

    :cond_5
    const-string p2, "Global.low_power changed to 0"

    .line 244
    :goto_3
    const/16 p3, 0x8

    invoke-direct {p0, p1, v0, p3, p2}, Lcom/android/server/power/batterysaver/BatterySaverStateMachine;->enableBatterySaverLocked(ZZILjava/lang/String;)V
