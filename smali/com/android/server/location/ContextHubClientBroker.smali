...
.method onNanoAppAborted(JI)V
    ...
    const-string v0, "RemoteException while calling onNanoAppAborted on client (host endpoint ID = "
...
.method onNanoAppLoaded(J)V
    ...
    const-string v1, "RemoteException while calling onNanoAppLoaded on client (host endpoint ID = "
...
.method onNanoAppUnloaded(J)V
    ...
    const-string v1, "RemoteException while calling onNanoAppUnloaded on client (host endpoint ID = "
...
.method sendMessageToClient(Landroid/hardware/location/NanoAppMessage;)V
    ...
    const-string v2, "RemoteException while sending message to client (host endpoint ID = "
...
.method public sendMessageToNanoApp(Landroid/hardware/location/NanoAppMessage;)I
    ...
    .line 116
    :try_start_0
    iget-object v0, p0, Lcom/android/server/location/ContextHubClientBroker;->mContextHubProxy:Landroid/hardware/contexthub/V1_0/IContexthub;

    iget v2, p0, Lcom/android/server/location/ContextHubClientBroker;->mAttachedContextHubId:I

    invoke-interface {v0, v2, p1}, Landroid/hardware/contexthub/V1_0/IContexthub;->sendMessageToHub(ILandroid/hardware/contexthub/V1_0/ContextHubMsg;)I
