...
.method private static amfmConfigToBands(Landroid/hardware/broadcastradio/V2_0/AmFmRegionConfig;)[Landroid/hardware/radio/RadioManager$BandDescriptor;
    ...
    .line 184
    new-instance v4, Landroid/hardware/radio/RadioManager$FmBandDescriptor;

    const/4 v8, 0x1

    iget v9, v3, Landroid/hardware/broadcastradio/V2_0/AmFmBandRange;->lowerBound:I

    iget v10, v3, Landroid/hardware/broadcastradio/V2_0/AmFmBandRange;->upperBound:I

    iget v11, v3, Landroid/hardware/broadcastradio/V2_0/AmFmBandRange;->spacing:I
...
.method private static identifierTypesToProgramTypes([I)[I
    ...
    sget-object v0, Lcom/android/server/broadcastradio/hal2/-$$Lambda$Convert$UV1wDVoVlbcxpr8zevj_aMFtUGw;->INSTANCE:Lcom/android/server/broadcastradio/hal2/-$$Lambda$Convert$UV1wDVoVlbcxpr8zevj_aMFtUGw;
...
.method private static metadataFromHal(Ljava/util/ArrayList;)Landroid/hardware/radio/RadioMetadata;
    ...
    const-string v4, "Ignored unknown metadata entry: "
...
.method static programSelectorFromHal(Landroid/hardware/broadcastradio/V2_0/ProgramSelector;)Landroid/hardware/radio/ProgramSelector;
    ...
    invoke-direct {v1, v2, p0, v0, v3}, Landroid/hardware/radio/ProgramSelector;-><init>(ILandroid/hardware/radio/ProgramSelector$Identifier;[Landroid/hardware/radio/ProgramSelector$Identifier;[J)V
...
.method static programSelectorToHal(Landroid/hardware/radio/ProgramSelector;)Landroid/hardware/broadcastradio/V2_0/ProgramSelector;
    ...
    new-instance v2, Lcom/android/server/broadcastradio/hal2/-$$Lambda$Convert$pxxBeAmtGFx0TmOA-6MMwqs_fi0;

    invoke-direct {v2, v1}, Lcom/android/server/broadcastradio/hal2/-$$Lambda$Convert$pxxBeAmtGFx0TmOA-6MMwqs_fi0;-><init>(Ljava/util/ArrayList;)V
