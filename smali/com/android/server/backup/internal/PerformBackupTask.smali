...
.method public constructor <init>(Lcom/android/server/backup/BackupManagerService;Lcom/android/server/backup/transport/TransportClient;Ljava/lang/String;Ljava/util/ArrayList;Lcom/android/server/backup/DataChangedJournal;Landroid/app/backup/IBackupObserver;Landroid/app/backup/IBackupManagerMonitor;Lcom/android/server/backup/internal/OnTaskFinishedListener;Ljava/util/List;ZZ)V
    ...
    iput-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mCancelLock:Ljava/lang/Object;

    .line 156
    iput-object v13, v0, Lcom/android/server/backup/internal/PerformBackupTask;->backupManagerService:Lcom/android/server/backup/BackupManagerService;

    .line 157
    move-object/from16 v3, p2

    iput-object v3, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mTransportClient:Lcom/android/server/backup/transport/TransportClient;

    .line 158
    move-object/from16 v1, p4

    iput-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mOriginalQueue:Ljava/util/ArrayList;
    ...
    iput-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mQueue:Ljava/util/ArrayList;

    .line 160
    move-object/from16 v1, p5

    iput-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mJournal:Lcom/android/server/backup/DataChangedJournal;

    .line 161
    move-object/from16 v1, p6

    iput-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mObserver:Landroid/app/backup/IBackupObserver;

    .line 162
    move-object/from16 v1, p7

    iput-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mMonitor:Landroid/app/backup/IBackupManagerMonitor;
    ...
    :cond_0
    sget-object v1, Lcom/android/server/backup/internal/OnTaskFinishedListener;->NOP:Lcom/android/server/backup/internal/OnTaskFinishedListener;

    :goto_0
    iput-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;

    .line 164
    move-object/from16 v1, p9

    iput-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mPendingFullBackups:Ljava/util/List;

    .line 165
    move/from16 v1, p10

    iput-boolean v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mUserInitiated:Z

    .line 166
    move/from16 v1, p11

    iput-boolean v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mNonIncremental:Z
    ...
    iput-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mAgentTimeoutParameters:Lcom/android/server/backup/BackupAgentTimeoutParameters;
    ...
    iput-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mStateDir:Ljava/io/File;
    ...
    iput v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mCurrentOpToken:I

    .line 174
    const/4 v1, 0x0

    iput-boolean v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mFinished:Z
    ...
    .line 181
    iput-boolean v2, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mCancelAll:Z

    .line 182
    const/4 v1, 0x0

    iput-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mFullBackupTask:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;

    .line 183
    sget-object v1, Lcom/android/server/backup/internal/BackupState;->FINAL:Lcom/android/server/backup/internal/BackupState;

    iput-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mCurrentState:Lcom/android/server/backup/internal/BackupState;

    .line 184
    const-string v0, "Skipped. Backup already in progress."

    invoke-virtual {v13, v0}, Lcom/android/server/backup/BackupManagerService;->addBackupTrace(Ljava/lang/String;)V
    ...
    .line 188
    iget-object v1, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mPendingFullBackups:Ljava/util/List;

    iget-object v2, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mPendingFullBackups:Ljava/util/List;
    ...
    iget-object v9, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mObserver:Landroid/app/backup/IBackupObserver;

    iget-object v10, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mMonitor:Landroid/app/backup/IBackupManagerMonitor;

    iget-object v11, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mListener:Lcom/android/server/backup/internal/OnTaskFinishedListener;

    iget-boolean v12, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mUserInitiated:Z
    ...
    iput-object v15, v0, Lcom/android/server/backup/internal/PerformBackupTask;->mFullBackupTask:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
...
.method private SHA1Checksum([B)Ljava/lang/String;
    ...
    .line 767
    const-string p1, "PerformBackupTask"
...
.method private backupPm()V
    ...
    .line 365
    invoke-direct {p0, v1, v0}, Lcom/android/server/backup/internal/PerformBackupTask;->invokeAgentForBackup(Ljava/lang/String;Landroid/app/IBackupAgent;)I
...
.method private beginBackup()V
    ...
    .line 259
    iget-object v2, v2, Lcom/android/server/backup/internal/BackupRequest;->packageName:Ljava/lang/String;
    ...
    const-string v6, "Initializing (wiping) backup state and transport storage"
    ...
    const-string v7, "initializing transport "
    ...
    invoke-virtual {v2, v5}, Lcom/android/server/backup/BackupManagerService;->addBackupTrace(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v5}, Lcom/android/server/backup/BackupManagerService;->resetBackupState(Ljava/io/File;)V
    ...
    iput v2, p0, Lcom/android/server/backup/internal/PerformBackupTask;->mStatus:I
    ...
    const-string/jumbo v5, "transport.initializeDevice() == "
    ...
    const-string v1, "Skipping backup of package metadata."
    ...
    const-string v2, "exiting prelim: "
    ...
    const-string v2, "Error in backup thread during init"
    ...
    const-string v4, "Exception in backup thread during init: "
...
.method private executeNextState(Lcom/android/server/backup/internal/BackupState;)V
    ...
    .line 1221
    iget-object p1, p0, Lcom/android/server/backup/internal/PerformBackupTask;->backupManagerService:Lcom/android/server/backup/BackupManagerService;
...
.method private finalizeBackup()V
    ...
    iget-object v1, v1, Lcom/android/server/backup/internal/BackupRequest;->packageName:Ljava/lang/String;

    invoke-virtual {v2, v1}, Lcom/android/server/backup/BackupManagerService;->dataChangedImpl(Ljava/lang/String;)V
    ...
    const-string v2, "full-transport-requested"
    ...
    .line 622
    iget-object v0, p0, Lcom/android/server/backup/internal/PerformBackupTask;->mFullBackupTask:Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;
    ...
    invoke-virtual {v0}, Lcom/android/server/backup/fullbackup/PerformFullTransportBackupTask;->unregisterTask()V
...
.method private invokeAgentForBackup(Ljava/lang/String;Landroid/app/IBackupAgent;)I
    ...
    iget-object v0, v7, Lcom/android/server/backup/internal/PerformBackupTask;->mStateDir:Ljava/io/File;
    ...
    iget-object v3, v7, Lcom/android/server/backup/internal/PerformBackupTask;->mBackupDataName:Ljava/io/File;
    ...
    const-string v1, "PBT.invokeAgentForBackup()"
    ...
    .line 716
    invoke-interface {v0, v8, v11}, Lcom/android/internal/backup/IBackupTransport;->getBackupQuota(Ljava/lang/String;Z)J
    ...
    .line 727
    iget-object v13, v7, Lcom/android/server/backup/internal/PerformBackupTask;->mSavedState:Landroid/os/ParcelFileDescriptor;

    iget-object v14, v7, Lcom/android/server/backup/internal/PerformBackupTask;->mBackupData:Landroid/os/ParcelFileDescriptor;

    iget-object v15, v7, Lcom/android/server/backup/internal/PerformBackupTask;->mNewState:Landroid/os/ParcelFileDescriptor;
    ...
    invoke-interface/range {v12 .. v20}, Landroid/app/IBackupAgent;->doBackup(Landroid/os/ParcelFileDescriptor;Landroid/os/ParcelFileDescriptor;Landroid/os/ParcelFileDescriptor;JILandroid/app/backup/IBackupManager;I)V
    :try_end_1
    ...
    .line 739
    :goto_2
    iget-boolean v1, v7, Lcom/android/server/backup/internal/PerformBackupTask;->mNonIncremental:Z
...
.method private invokeNextAgent()V
    ...
    const-string v4, "launch agent for "
    ...
    iget-object v9, v1, Lcom/android/server/backup/internal/BackupRequest;->packageName:Ljava/lang/String;
    ...
    const-string/jumbo v8, "skipping - not eligible, completion is noop"
    ...
    invoke-static {v6, v8, v7}, Lcom/android/server/backup/utils/BackupObserverUtils;->sendBackupOnPackageResult(Landroid/app/backup/IBackupObserver;Ljava/lang/String;I)V
    ...
    const-string/jumbo v8, "skipping - fullBackupOnly, completion is noop"
    ...
    const-string/jumbo v8, "skipping - stopped"
    ...
    invoke-virtual {v6, v7, v0}, Lcom/android/server/backup/BackupManagerService;->bindToAgentSynchronous(Landroid/content/pm/ApplicationInfo;I)Landroid/app/IBackupAgent;
    ...
    .line 485
    iput-object v6, p0, Lcom/android/server/backup/internal/PerformBackupTask;->mAgentBinder:Landroid/app/IBackupAgent;

    .line 486
    iget-object v7, v1, Lcom/android/server/backup/internal/BackupRequest;->packageName:Ljava/lang/String;

    invoke-direct {p0, v7, v6}, Lcom/android/server/backup/internal/PerformBackupTask;->invokeAgentForBackup(Ljava/lang/String;Landroid/app/IBackupAgent;)I
...
.method private revertAndEndBackup()V
    ...
    .line 1170
    iget-object v0, p0, Lcom/android/server/backup/internal/PerformBackupTask;->mOriginalQueue:Ljava/util/ArrayList;
...
.method private writeWidgetPayloadIfAppropriate(Ljava/io/FileDescriptor;Ljava/lang/String;)V
    ...
    .line 813
    :try_start_2
    invoke-static {v2, v4}, Lcom/android/server/backup/internal/PerformBackupTask;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_2
    .catch Ljava/lang/Throwable; {:try_start_2 .. :try_end_2} :catch_1
    .catchall {:try_start_2 .. :try_end_2} :catchall_2

    invoke-static {v2, p2}, Lcom/android/server/backup/internal/PerformBackupTask;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    ...
    :goto_0
    :try_start_4
    invoke-static {v0, v4}, Lcom/android/server/backup/internal/PerformBackupTask;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    ...
    .line 828
    :try_start_8
    invoke-static {v2, v1}, Lcom/android/server/backup/internal/PerformBackupTask;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_8
    .catch Ljava/lang/Throwable; {:try_start_8 .. :try_end_8} :catch_3
    .catchall {:try_start_8 .. :try_end_8} :catchall_5

    invoke-static {v2, p1}, Lcom/android/server/backup/internal/PerformBackupTask;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    ...
    :goto_2
    :try_start_a
    invoke-static {v0, v1}, Lcom/android/server/backup/internal/PerformBackupTask;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
...
.method public handleCancel(Z)V
    ...
    .line 1124
    :cond_1
    const-string v1, "no_package_yet"
    ...
    invoke-virtual {v2, v1}, Lcom/android/server/backup/BackupManagerService;->addBackupTrace(Ljava/lang/String;)V
    ...
    const-string v6, "android.app.backup.extra.LOG_CANCEL_ALL"

    iget-boolean v7, p0, Lcom/android/server/backup/internal/PerformBackupTask;->mCancelAll:Z

    .line 1132
    invoke-static {v5, v6, v7}, Lcom/android/server/backup/utils/BackupManagerMonitorUtils;->putMonitoringExtra(Landroid/os/Bundle;Ljava/lang/String;Z)Landroid/os/Bundle;

    move-result-object v5

    .line 1129
    invoke-static {v1, v2, v3, v4, v5}, Lcom/android/server/backup/utils/BackupManagerMonitorUtils;->monitorEvent(Landroid/app/backup/IBackupManagerMonitor;ILandroid/content/pm/PackageInfo;ILandroid/os/Bundle;)Landroid/app/backup/IBackupManagerMonitor;
    ...
    .line 1142
    iget-object p1, p0, Lcom/android/server/backup/internal/PerformBackupTask;->mQueue:Ljava/util/ArrayList;
    ...
    sget-object p1, Lcom/android/server/backup/internal/BackupState;->FINAL:Lcom/android/server/backup/internal/BackupState;

    goto :goto_1

    :cond_2
    sget-object p1, Lcom/android/server/backup/internal/BackupState;->RUNNING_QUEUE:Lcom/android/server/backup/internal/BackupState;

    .line 1141
    :goto_1
    invoke-direct {p0, p1}, Lcom/android/server/backup/internal/PerformBackupTask;->executeNextState(Lcom/android/server/backup/internal/BackupState;)V
    ...
    invoke-virtual {p1, v1}, Lcom/android/server/backup/BackupManagerService;->dataChangedImpl(Ljava/lang/String;)V
...
.method public operationComplete(J)V
    ...
    const-string/jumbo v1, "operationComplete received after task finished."
    ...
    .line 860
    :goto_0
    iget-object v1, v1, Lcom/android/server/backup/internal/PerformBackupTask;->backupManagerService:Lcom/android/server/backup/BackupManagerService;
    ...
    const-string v9, "Illegal backup key: "
    ...
    invoke-direct {v1, v0, v7}, Lcom/android/server/backup/internal/PerformBackupTask;->failAgent(Landroid/app/IBackupAgent;Ljava/lang/String;)V
    ...
    .line 891
    invoke-static {v11, v12, v15}, Lcom/android/server/backup/utils/BackupManagerMonitorUtils;->putMonitoringExtra(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/String;)Landroid/os/Bundle;

    move-result-object v12

    .line 886
    invoke-static {v0, v7, v9, v8, v12}, Lcom/android/server/backup/utils/BackupManagerMonitorUtils;->monitorEvent(Landroid/app/backup/IBackupManagerMonitor;ILandroid/content/pm/PackageInfo;ILandroid/os/Bundle;)Landroid/app/backup/IBackupManagerMonitor;
    ...
    .line 897
    invoke-static {v0, v3, v7}, Lcom/android/server/backup/utils/BackupObserverUtils;->sendBackupOnPackageResult(Landroid/app/backup/IBackupObserver;Ljava/lang/String;I)V
    ...
    const-string v4, "Unable to roll back!"
    ...
    const-string/jumbo v4, "operation complete"
    ...
    const-string v4, "PBT.operationComplete()"

    invoke-virtual {v0, v4}, Lcom/android/server/backup/transport/TransportClient;->connect(Ljava/lang/String;)Lcom/android/internal/backup/IBackupTransport;
    ...
    :try_start_a
    invoke-static {v4}, Lcom/android/server/backup/transport/TransportUtils;->checkTransportNotNull(Lcom/android/internal/backup/IBackupTransport;)Lcom/android/internal/backup/IBackupTransport;
    ...
    :goto_4
    iget v8, v1, Lcom/android/server/backup/internal/PerformBackupTask;->mStatus:I

    if-nez v8, :cond_a

    .line 946
    iget-object v8, v1, Lcom/android/server/backup/internal/PerformBackupTask;->mBackupDataName:Ljava/io/File;
    ...
    .line 948
    :try_start_c
    iget-object v14, v1, Lcom/android/server/backup/internal/PerformBackupTask;->backupManagerService:Lcom/android/server/backup/BackupManagerService;

    const-string/jumbo v15, "sending data to transport"

    invoke-virtual {v14, v15}, Lcom/android/server/backup/BackupManagerService;->addBackupTrace(Ljava/lang/String;)V

    .line 951
    iget-boolean v14, v1, Lcom/android/server/backup/internal/PerformBackupTask;->mUserInitiated:Z
    ...
    invoke-interface {v4, v15, v8, v14}, Lcom/android/internal/backup/IBackupTransport;->performBackup(Landroid/content/pm/PackageInfo;Landroid/os/ParcelFileDescriptor;I)I
    ...
    const-string v14, "Transport requested non-incremental but already the case, error"
    ...
    invoke-virtual {v0, v14}, Lcom/android/server/backup/BackupManagerService;->addBackupTrace(Ljava/lang/String;)V

    .line 971
    iput v12, v1, Lcom/android/server/backup/internal/PerformBackupTask;->mStatus:I
    ...
    const-string v15, "data delivered: "

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget v15, v1, Lcom/android/server/backup/internal/PerformBackupTask;->mStatus:I
    ...
    const-string v14, "finishing op on transport"
    ...
    const-string/jumbo v14, "transport rejected package"
    ...
    const-string v14, "no data to send"
    ...
    invoke-static {v0, v14, v15, v8, v11}, Lcom/android/server/backup/utils/BackupManagerMonitorUtils;->monitorEvent(Landroid/app/backup/IBackupManagerMonitor;ILandroid/content/pm/PackageInfo;ILandroid/os/Bundle;)Landroid/app/backup/IBackupManagerMonitor;
    ...
    iget-object v11, v1, Lcom/android/server/backup/internal/PerformBackupTask;->mSavedStateName:Ljava/io/File;
    ...
    .line 1006
    invoke-static {v0, v3, v13}, Lcom/android/server/backup/utils/BackupObserverUtils;->sendBackupOnPackageResult(Landroid/app/backup/IBackupObserver;Ljava/lang/String;I)V
    ...
    invoke-static {v0, v3, v9}, Lcom/android/server/backup/utils/BackupObserverUtils;->sendBackupOnPackageResult(Landroid/app/backup/IBackupObserver;Ljava/lang/String;I)V
    ...
    const-string v14, "Transport lost data, retrying package:"
    ...
    iget-object v14, v1, Lcom/android/server/backup/internal/PerformBackupTask;->mCurrentPackage:Landroid/content/pm/PackageInfo;

    const/4 v15, 0x1

    invoke-static {v0, v10, v14, v15, v11}, Lcom/android/server/backup/utils/BackupManagerMonitorUtils;->monitorEvent(Landroid/app/backup/IBackupManagerMonitor;ILandroid/content/pm/PackageInfo;ILandroid/os/Bundle;)Landroid/app/backup/IBackupManagerMonitor;
    ...
    invoke-static {v0, v3, v12}, Lcom/android/server/backup/utils/BackupObserverUtils;->sendBackupOnPackageResult(Landroid/app/backup/IBackupObserver;Ljava/lang/String;I)V
    ...
    invoke-static {v8, v3, v12}, Lcom/android/server/backup/utils/BackupObserverUtils;->sendBackupOnPackageResult(Landroid/app/backup/IBackupObserver;Ljava/lang/String;I)V
    ...
    invoke-static {v8, v3}, Landroid/util/EventLog;->writeEvent(ILjava/lang/String;)I
    ...
    invoke-interface {v4, v0, v13}, Lcom/android/internal/backup/IBackupTransport;->getBackupQuota(Ljava/lang/String;Z)J
    ...
    invoke-interface {v0, v5, v6, v3, v4}, Landroid/app/IBackupAgent;->doQuotaExceeded(JJ)V
    :try_end_13
    ...
    const-string v5, "Unable to notify about quota exceeded: "
