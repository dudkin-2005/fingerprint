...
.method constructor <init>(Lcom/android/server/wm/DragState;Landroid/view/Display;)V
    ...
    iget-object v3, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mServerChannel:Landroid/view/InputChannel;

    const/4 v4, 0x0

    invoke-virtual {v0, v3, v4}, Lcom/android/server/input/InputManagerService;->registerInputChannel(Landroid/view/InputChannel;Lcom/android/server/input/InputWindowHandle;)V
    ...
    iget-object v6, p1, Lcom/android/server/wm/DragState;->mDragDropController:Lcom/android/server/wm/DragDropController;

    invoke-direct {v0, v3, v5, v6}, Lcom/android/server/wm/DragInputEventReceiver;-><init>(Landroid/view/InputChannel;Landroid/os/Looper;Lcom/android/server/wm/DragDropController;)V
    ...
    invoke-direct {v0, v4}, Lcom/android/server/input/InputApplicationHandle;-><init>(Ljava/lang/Object;)V
    ...
    .line 222
    iget-object v0, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragApplicationHandle:Lcom/android/server/input/InputApplicationHandle;

    const-string v3, "drag"

    iput-object v3, v0, Lcom/android/server/input/InputApplicationHandle;->name:Ljava/lang/String;
    ...
    iput-wide v5, v0, Lcom/android/server/input/InputApplicationHandle;->dispatchingTimeoutNanos:J
    ...
    invoke-direct {v0, v3, v4, v4, p2}, Lcom/android/server/input/InputWindowHandle;-><init>(Lcom/android/server/input/InputApplicationHandle;Ljava/lang/Object;Landroid/view/IWindow;I)V
    ...
    .line 228
    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Lcom/android/server/input/InputWindowHandle;

    const-string v0, "drag"

    iput-object v0, p2, Lcom/android/server/input/InputWindowHandle;->name:Ljava/lang/String;
    ...
    iput-object v0, p2, Lcom/android/server/input/InputWindowHandle;->inputChannel:Landroid/view/InputChannel;
    ...
    iput v0, p2, Lcom/android/server/input/InputWindowHandle;->layer:I

    .line 231
    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Lcom/android/server/input/InputWindowHandle;

    iput v1, p2, Lcom/android/server/input/InputWindowHandle;->layoutParamsFlags:I
    ...
    iput v0, p2, Lcom/android/server/input/InputWindowHandle;->layoutParamsType:I

    .line 233
    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Lcom/android/server/input/InputWindowHandle;

    iput-wide v5, p2, Lcom/android/server/input/InputWindowHandle;->dispatchingTimeoutNanos:J

    .line 235
    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Lcom/android/server/input/InputWindowHandle;

    iput-boolean v2, p2, Lcom/android/server/input/InputWindowHandle;->visible:Z

    .line 236
    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Lcom/android/server/input/InputWindowHandle;

    iput-boolean v1, p2, Lcom/android/server/input/InputWindowHandle;->canReceiveKeys:Z

    .line 237
    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Lcom/android/server/input/InputWindowHandle;

    iput-boolean v2, p2, Lcom/android/server/input/InputWindowHandle;->hasFocus:Z

    .line 238
    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Lcom/android/server/input/InputWindowHandle;

    iput-boolean v1, p2, Lcom/android/server/input/InputWindowHandle;->hasWallpaper:Z

    .line 239
    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Lcom/android/server/input/InputWindowHandle;

    iput-boolean v1, p2, Lcom/android/server/input/InputWindowHandle;->paused:Z
    ...
    iput v0, p2, Lcom/android/server/input/InputWindowHandle;->ownerPid:I
    ...
    iput v0, p2, Lcom/android/server/input/InputWindowHandle;->ownerUid:I

    .line 242
    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Lcom/android/server/input/InputWindowHandle;

    iput v1, p2, Lcom/android/server/input/InputWindowHandle;->inputFeatures:I
    ...
    iput v0, p2, Lcom/android/server/input/InputWindowHandle;->scaleFactor:F

    .line 246
    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Lcom/android/server/input/InputWindowHandle;

    iget-object p2, p2, Lcom/android/server/input/InputWindowHandle;->touchableRegion:Landroid/graphics/Region;
    ...
    iput v1, p2, Lcom/android/server/input/InputWindowHandle;->frameLeft:I

    .line 250
    iget-object p2, p0, Lcom/android/server/wm/DragState$InputInterceptor;->mDragWindowHandle:Lcom/android/server/input/InputWindowHandle;

    iput v1, p2, Lcom/android/server/input/InputWindowHandle;->frameTop:I
    ...
    iput v0, p2, Lcom/android/server/input/InputWindowHandle;->frameRight:I
    ...
    iput v0, p2, Lcom/android/server/input/InputWindowHandle;->frameBottom:I
