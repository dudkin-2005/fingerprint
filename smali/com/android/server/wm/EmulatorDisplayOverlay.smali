...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/DisplayContent;I)V
    ...
    .line 62
    invoke-virtual {p2, v1, v2}, Landroid/view/SurfaceControl$Builder;->setSize(II)Landroid/view/SurfaceControl$Builder;
    ...
    .line 65
    :try_start_1
    invoke-virtual {p2, p3}, Landroid/view/SurfaceControl;->setLayer(I)V

    .line 66
    const/4 p3, 0x0

    invoke-virtual {p2, p3, p3}, Landroid/view/SurfaceControl;->setPosition(FF)V

    .line 67
    invoke-virtual {p2}, Landroid/view/SurfaceControl;->show()V

    .line 68
    iget-object p3, p0, Lcom/android/server/wm/EmulatorDisplayOverlay;->mSurface:Landroid/view/Surface;

    invoke-virtual {p3, p2}, Landroid/view/Surface;->copyFrom(Landroid/view/SurfaceControl;)V
    :try_end_1
    ...
    .line 71
    :goto_0
    iput-object p2, p0, Lcom/android/server/wm/EmulatorDisplayOverlay;->mSurfaceControl:Landroid/view/SurfaceControl;
