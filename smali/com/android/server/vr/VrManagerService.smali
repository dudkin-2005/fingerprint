...
.method private consumeAndApplyPendingStateLocked(Z)V
    ...
    iget-boolean v1, p1, Lcom/android/server/vr/VrManagerService$VrState;->enabled:Z

    iget-object p1, p0, Lcom/android/server/vr/VrManagerService;->mPendingState:Lcom/android/server/vr/VrManagerService$VrState;

    iget-boolean v2, p1, Lcom/android/server/vr/VrManagerService$VrState;->running2dInVr:Z

    iget-object p1, p0, Lcom/android/server/vr/VrManagerService;->mPendingState:Lcom/android/server/vr/VrManagerService$VrState;

    iget-object v3, p1, Lcom/android/server/vr/VrManagerService$VrState;->targetPackageName:Landroid/content/ComponentName;

    iget-object p1, p0, Lcom/android/server/vr/VrManagerService;->mPendingState:Lcom/android/server/vr/VrManagerService$VrState;

    iget v4, p1, Lcom/android/server/vr/VrManagerService$VrState;->userId:I

    iget-object p1, p0, Lcom/android/server/vr/VrManagerService;->mPendingState:Lcom/android/server/vr/VrManagerService$VrState;

    iget v5, p1, Lcom/android/server/vr/VrManagerService$VrState;->processId:I

    iget-object p1, p0, Lcom/android/server/vr/VrManagerService;->mPendingState:Lcom/android/server/vr/VrManagerService$VrState;

    iget-object v6, p1, Lcom/android/server/vr/VrManagerService$VrState;->callingPackage:Landroid/content/ComponentName;
...
.method private grantCoarseLocationPermissionIfNeeded(Ljava/lang/String;I)V
    ...
    const-string v1, "Could not grant coarse location permission, package "
...
.method private revokeCoarseLocationPermissionIfNeeded(Ljava/lang/String;I)V
    ...
    const-string v1, "Could not revoke coarse location permission, package "
...
.method private setVrMode(ZLandroid/content/ComponentName;IILandroid/content/ComponentName;)V
    ...
    iget-boolean v1, v0, Lcom/android/server/vr/VrManagerService;->mPersistentVrModeEnabled:Z
    ...
    .line 1290
    iget-boolean v2, v0, Lcom/android/server/vr/VrManagerService;->mVrModeAllowed:Z
    ...
    .line 1301
    iget-object v2, v0, Lcom/android/server/vr/VrManagerService;->mPendingState:Lcom/android/server/vr/VrManagerService$VrState;

    if-nez v2, :cond_5

    .line 1302
    iget-object v2, v0, Lcom/android/server/vr/VrManagerService;->mHandler:Landroid/os/Handler;
...
.method private updateCurrentVrServiceLocked(ZZLandroid/content/ComponentName;IILandroid/content/ComponentName;)Z
    ...
    const-string v15, "Leaving VR mode, disconnecting "
    ...
    .line 936
    invoke-virtual {v15}, Lcom/android/server/utils/ManagedApplicationService;->getUserId()I
    ...
    const-string v8, "VR mode component changed to "
    ...
    iget-object v8, v0, Lcom/android/server/vr/VrManagerService;->mCurrentVrService:Lcom/android/server/utils/ManagedApplicationService;
    ...
    .line 951
    invoke-virtual {v8}, Lcom/android/server/utils/ManagedApplicationService;->getUserId()I
...
.method private updateVrModeAllowedLocked()V
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/server/vr/VrManagerService$VrState;-><init>(ZZLandroid/content/ComponentName;IILandroid/content/ComponentName;)V
...
.method public onBootPhase(I)V
    ...
    .line 781
    invoke-virtual {p1, p0}, Landroid/app/ActivityManagerInternal;->registerScreenObserver(Landroid/app/ActivityManagerInternal$ScreenObserver;)V
