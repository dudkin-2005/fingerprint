...
.method private skipResizeAnimation(Z)Z
    ...
    invoke-virtual {v1, p1}, Lcom/android/server/am/ActivityRecord;->isConfigurationCompatible(Landroid/content/res/Configuration;)Z
...
.method animateResizePinnedStack(Landroid/graphics/Rect;Landroid/graphics/Rect;IZ)V
    ...
    .line 58
    iget-object p1, p0, Lcom/android/server/am/PinnedActivityStack;->mService:Lcom/android/server/am/ActivityManagerService;

    iget p2, p0, Lcom/android/server/am/PinnedActivityStack;->mStackId:I

    invoke-virtual {p1, p2, v0}, Lcom/android/server/am/ActivityManagerService;->moveTasksToFullscreenStack(IZ)V
