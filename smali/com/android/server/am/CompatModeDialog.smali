...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Landroid/content/pm/ApplicationInfo;)V
    ...
    invoke-virtual {p0, p2}, Lcom/android/server/am/CompatModeDialog;->setCancelable(Z)V

    .line 43
    invoke-virtual {p0, p2}, Lcom/android/server/am/CompatModeDialog;->setCanceledOnTouchOutside(Z)V
    ...
    invoke-virtual {v0, p2}, Landroid/view/Window;->requestFeature(I)Z
    ...
    invoke-virtual {p0, p1}, Lcom/android/server/am/CompatModeDialog;->setContentView(I)V

    .line 51
    const p1, 0x102020c

    invoke-virtual {p0, p1}, Lcom/android/server/am/CompatModeDialog;->findViewById(I)Landroid/view/View;

    move-result-object p1

    check-cast p1, Landroid/widget/Switch;

    iput-object p1, p0, Lcom/android/server/am/CompatModeDialog;->mCompatEnabled:Landroid/widget/Switch;

    .line 52
    iget-object p1, p0, Lcom/android/server/am/CompatModeDialog;->mCompatEnabled:Landroid/widget/Switch;

    new-instance p2, Lcom/android/server/am/CompatModeDialog$1;

    invoke-direct {p2, p0}, Lcom/android/server/am/CompatModeDialog$1;-><init>(Lcom/android/server/am/CompatModeDialog;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/CompatModeDialog;->mAlwaysShow:Landroid/widget/CheckBox;

    .line 65
    iget-object p1, p0, Lcom/android/server/am/CompatModeDialog;->mAlwaysShow:Landroid/widget/CheckBox;

    new-instance p2, Lcom/android/server/am/CompatModeDialog$2;

    invoke-direct {p2, p0}, Lcom/android/server/am/CompatModeDialog$2;-><init>(Lcom/android/server/am/CompatModeDialog;)V
    ...
    iput-object p1, p0, Lcom/android/server/am/CompatModeDialog;->mHint:Landroid/view/View;
...
.method updateControls()V
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/am/CompatModePackages;->getPackageAskCompatModeLocked(Ljava/lang/String;)Z

    move-result v1

    .line 86
    iget-object v2, p0, Lcom/android/server/am/CompatModeDialog;->mAlwaysShow:Landroid/widget/CheckBox;

    invoke-virtual {v2, v1}, Landroid/widget/CheckBox;->setChecked(Z)V

    .line 87
    iget-object v2, p0, Lcom/android/server/am/CompatModeDialog;->mHint:Landroid/view/View;
