...
.method private extractDeltaLocked(Landroid/net/wifi/WifiActivityEnergyInfo;)Landroid/net/wifi/WifiActivityEnergyInfo;
    ...
    .line 576
    const-string v4, " is longer than sample period "
    ...
    .line 579
    const-string v2, "Previous WiFi snapshot: "
    ...
    .line 587
    const-string v2, "Current WiFi snapshot: "
    ...
    iget-wide v6, v1, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerRxTimeMs:J

    add-long/2addr v4, v6

    iget-wide v6, v1, Landroid/net/wifi/WifiActivityEnergyInfo;->mControllerIdleTimeMs:J
    ...
    const-string v4, "WiFi energy data was reset, new WiFi energy data is "
...
.method private updateExternalStatsLocked(Ljava/lang/String;IZZZ)V
    ...
    invoke-direct {v4, v0}, Landroid/os/SynchronousResultReceiver;-><init>(Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-interface {v0, v4}, Landroid/net/wifi/IWifiManager;->requestActivityInfo(Landroid/os/ResultReceiver;)V
    :try_end_1
    ...
    .line 423
    invoke-virtual {v0, v5}, Landroid/bluetooth/BluetoothAdapter;->requestControllerActivityEnergyInfo(Landroid/os/ResultReceiver;)V
    ...
    invoke-virtual/range {v6 .. v13}, Lcom/android/internal/os/BatteryStatsImpl;->addHistoryEventLocked(JJILjava/lang/String;I)V
    ...
    invoke-virtual {v6}, Lcom/android/internal/os/BatteryStatsImpl;->isOnBatteryLocked()Z
    ...
    invoke-virtual {v7}, Lcom/android/internal/os/BatteryStatsImpl;->isOnBatteryScreenOffLocked()Z
    ...
    invoke-virtual {v8, v6, v7}, Lcom/android/internal/os/BatteryStatsImpl;->updateCpuTimeLocked(ZZ)V
    ...
    invoke-virtual {v6}, Lcom/android/internal/os/BatteryStatsImpl;->updateKernelWakelocksLocked()V

    .line 460
    iget-object v6, v1, Lcom/android/server/am/BatteryExternalStatsWorker;->mStats:Lcom/android/internal/os/BatteryStatsImpl;

    invoke-virtual {v6}, Lcom/android/internal/os/BatteryStatsImpl;->updateKernelMemoryBandwidthLocked()V
    ...
    .line 464
    iget-object v2, v1, Lcom/android/server/am/BatteryExternalStatsWorker;->mStats:Lcom/android/internal/os/BatteryStatsImpl;

    invoke-virtual {v2}, Lcom/android/internal/os/BatteryStatsImpl;->updateRpmStatsLocked()V
    ...
    .line 468
    invoke-virtual {v4}, Landroid/bluetooth/BluetoothActivityEnergyInfo;->isValid()Z
    ...
    invoke-virtual {v2, v4}, Lcom/android/internal/os/BatteryStatsImpl;->updateBluetoothStateLocked(Landroid/bluetooth/BluetoothActivityEnergyInfo;)V
    ...
    invoke-direct {v1, v0}, Lcom/android/server/am/BatteryExternalStatsWorker;->extractDeltaLocked(Landroid/net/wifi/WifiActivityEnergyInfo;)Landroid/net/wifi/WifiActivityEnergyInfo;

    move-result-object v0

    invoke-virtual {v2, v0}, Lcom/android/internal/os/BatteryStatsImpl;->updateWifiState(Landroid/net/wifi/WifiActivityEnergyInfo;)V
    ...
    .line 488
    invoke-virtual {v3}, Landroid/telephony/ModemActivityInfo;->isValid()Z
    ...
    invoke-virtual {v0, v3}, Lcom/android/internal/os/BatteryStatsImpl;->updateMobileRadioState(Landroid/telephony/ModemActivityInfo;)V
    ...
    const-string v2, "modem info is invalid: "
