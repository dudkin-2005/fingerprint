...
.method calculate(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo$WindowLayout;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/am/LaunchParamsController$LaunchParams;)V
    ...
    .line 96
    :pswitch_1
    iget-object v0, v0, Lcom/android/server/am/LaunchParamsController;->mTmpResult:Lcom/android/server/am/LaunchParamsController$LaunchParams;

    invoke-virtual {v1, v0}, Lcom/android/server/am/LaunchParamsController$LaunchParams;->set(Lcom/android/server/am/LaunchParamsController$LaunchParams;)V
...
.method layoutTask(Lcom/android/server/am/TaskRecord;Landroid/content/pm/ActivityInfo$WindowLayout;Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Landroid/app/ActivityOptions;)Z
    ...
    .line 119
    iget-object p2, p0, Lcom/android/server/am/LaunchParamsController;->mTmpParams:Lcom/android/server/am/LaunchParamsController$LaunchParams;

    invoke-virtual {p2}, Lcom/android/server/am/LaunchParamsController$LaunchParams;->isEmpty()Z
    ...
    .line 123
    :cond_0
    iget-object p2, p0, Lcom/android/server/am/LaunchParamsController;->mService:Lcom/android/server/am/ActivityManagerService;
    ...
    invoke-virtual {p2}, Lcom/android/server/am/LaunchParamsController$LaunchParams;->hasPreferredDisplay()Z
    ...
    iget p2, p2, Lcom/android/server/am/LaunchParamsController$LaunchParams;->mPreferredDisplayId:I
    ...
    iget p4, p4, Lcom/android/server/am/ActivityDisplay;->mDisplayId:I
    ...
    iget-object p5, p0, Lcom/android/server/am/LaunchParamsController;->mTmpParams:Lcom/android/server/am/LaunchParamsController$LaunchParams;

    iget p5, p5, Lcom/android/server/am/LaunchParamsController$LaunchParams;->mPreferredDisplayId:I

    invoke-virtual {p2, p4, p5}, Lcom/android/server/am/ActivityManagerService;->moveStackToDisplay(II)V

    .line 131
    :cond_1
    iget-object p2, p0, Lcom/android/server/am/LaunchParamsController;->mTmpParams:Lcom/android/server/am/LaunchParamsController$LaunchParams;

    invoke-virtual {p2}, Lcom/android/server/am/LaunchParamsController$LaunchParams;->hasWindowingMode()Z
    ...
    iget p2, p2, Lcom/android/server/am/LaunchParamsController$LaunchParams;->mWindowingMode:I
    ...
    iget-object p4, p0, Lcom/android/server/am/LaunchParamsController;->mTmpParams:Lcom/android/server/am/LaunchParamsController$LaunchParams;

    iget p4, p4, Lcom/android/server/am/LaunchParamsController$LaunchParams;->mWindowingMode:I

    invoke-virtual {p2, p4}, Lcom/android/server/am/ActivityStack;->setWindowingMode(I)V

    .line 136
    :cond_2
    iget-object p2, p0, Lcom/android/server/am/LaunchParamsController;->mTmpParams:Lcom/android/server/am/LaunchParamsController$LaunchParams;

    iget-object p2, p2, Lcom/android/server/am/LaunchParamsController$LaunchParams;->mBounds:Landroid/graphics/Rect;
    ...
    .line 143
    iget-object p1, p0, Lcom/android/server/am/LaunchParamsController;->mService:Lcom/android/server/am/ActivityManagerService;
