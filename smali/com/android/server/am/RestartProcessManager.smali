...
.method private addSpecificList([Ljava/lang/String;)V
    ...
    # getter for: Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mPackageName:Ljava/lang/String;
...
.method private doCleanData(J)V
    ...
    :try_end_41
    .catchall {:try_start_8 .. :try_end_41} :catchall_76
    ...
    .catchall {:try_start_41 .. :try_end_68} :catchall_76
    ...
    monitor-exit p0
    :try_end_6e
    .catchall {:try_start_6a .. :try_end_6e} :catchall_76
...
.method private getAllPackagesByUsage(Z)Ljava/util/HashMap;
    ...
    monitor-exit p0
    :try_end_205
    .catchall {:try_start_77 .. :try_end_205} :catchall_20b
...
.method private rankAllPkgs()V
    ...
    monitor-enter p0
    :try_end_28
    .catch Ljava/lang/Exception; {:try_start_27 .. :try_end_28} :catch_346
    ...
    move-result v8
    :try_end_47
    .catchall {:try_start_28 .. :try_end_47} :catchall_33b
    ...
    invoke-virtual {v9, v5, v6}, Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->updateSelf(J)Z
    :try_end_93
    .catchall {:try_start_49 .. :try_end_93} :catchall_62
    ...
    :try_end_9c
    .catchall {:try_start_94 .. :try_end_9c} :catchall_33b
    ...
    # getter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mLastLaunchTime:J
    ...
    .end local v19    # "i":I
    .restart local v9    # "i":I
    # setter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->isFinished:Z
    ...
    # getter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->isFinished:Z
    ...
    :try_end_165
    .catchall {:try_start_9f .. :try_end_165} :catchall_62
    ...
    move-result v9
    :try_end_178
    .catchall {:try_start_16a .. :try_end_178} :catchall_33b
    ...
    # getter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mScoreLaunchTimes:D
    ...
    # getter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mScoreFGDuration:D
    ...
    # getter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mScoreLRU:D
    ...
    :try_end_1f6
    .catchall {:try_start_17a .. :try_end_1f6} :catchall_62
    ...
    move-result-wide v15
    :try_end_269
    .catchall {:try_start_204 .. :try_end_269} :catchall_33b
    ...
    monitor-exit p0
    :try_end_341
    .catchall {:try_start_27b .. :try_end_341} :catchall_344

    :try_start_341
    throw v0
    :try_end_342
    .catch Ljava/lang/Exception; {:try_start_341 .. :try_end_342} :catch_342
...
.method private rankDayRecords(Ljava/util/ArrayList;)V
    ...
    # getter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mTotalForegroundTime:J
    ...
    # setter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mScoreFGDuration:D
    ...
    # getter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mPackageName:Ljava/lang/String;
    ...
    # getter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mStartCountTime:J
    ...
    # setter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mScoreLRU:D
    ...
    # setter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mScoreLaunchTimes:D
...
.method private readFileContent(Ljava/io/File;)V
    ...
    # setter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mLastLaunchTime:J
    ...
    # setter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mOldForegroundTime:J
    ...
    # setter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mTotalLaunchTime:J
    ...
    # setter for: Lcom/android/server/am/RestartProcessManager$DayRecord;->mStartCountTime:J
    ...
    # setter for: Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mLastCountTime:J
    ...
    # setter for: Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mLastLaunchTime:J
    ...
    .catchall {:try_start_1 .. :try_end_175} :catchall_181
    ...
    :try_end_18e
    .catchall {:try_start_184 .. :try_end_18e} :catchall_181
    ...
    invoke-virtual {v0}, Ljava/io/BufferedReader;->close()V
    :try_end_193
    .catch Ljava/io/IOException; {:try_start_190 .. :try_end_193} :catch_17c
...
.method public static resolveConfig(Lorg/json/JSONArray;)V
    ...
    :try_end_b8
    .catch Ljava/lang/Exception; {:try_start_b .. :try_end_b8} :catch_b9
...
.method private setWhitelist()V
    ...
    monitor-exit p0
    :try_end_16c
    .catchall {:try_start_c .. :try_end_16c} :catchall_16a
...
.method public dump(Ljava/io/PrintWriter;Ljava/util/ArrayList;Z)V
    ...
    # += operator for: Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mTotalForegroundTime:J
    ...
    # += operator for: Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mTotalLaunchTime:J
    ...
    # getter for: Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mTotalLaunchTime:J
    ...
    .line 1109
    # getter for: Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mTotalForegroundTime:J
    ...
    # getter for: Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->mLastLaunchTime:J
    ...
    monitor-exit p0
    :try_end_188
    .catchall {:try_start_c .. :try_end_188} :catchall_186
...
.method public handleCommand([Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Ljava/util/HashMap;->clear()V
    :try_end_8f
    .catch Ljava/lang/Exception; {:try_start_23 .. :try_end_8f} :catch_92
    .catchall {:try_start_23 .. :try_end_8f} :catchall_90
...
.method public updateDuration(Ljava/lang/String;J)V
    ...
    # getter for: Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->isFinishLaunch:Z
    ...
    # setter for: Lcom/android/server/am/RestartProcessManager$PackageRankInfo;->isFinishLaunch:Z
...
.method public updateLaunchTime(Ljava/lang/String;J)V
    ...
    monitor-exit p0
    :try_end_73
    .catchall {:try_start_21 .. :try_end_73} :catchall_94
