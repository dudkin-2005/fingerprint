...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/os/Handler;)V
    ...
    .line 105
    sget p2, Lcom/android/server/am/ActivityManagerConstants;->DEFAULT_MAX_CACHED_PROCESSES:I

    iput p2, p0, Lcom/android/server/am/ActivityManagerConstants;->MAX_CACHED_PROCESSES:I
    ...
    iput p2, p0, Lcom/android/server/am/ActivityManagerConstants;->POWER_CHECK_MAX_CPU_1:I

    .line 161
    iput p2, p0, Lcom/android/server/am/ActivityManagerConstants;->POWER_CHECK_MAX_CPU_2:I

    .line 165
    const/16 p2, 0xa

    iput p2, p0, Lcom/android/server/am/ActivityManagerConstants;->POWER_CHECK_MAX_CPU_3:I

    .line 169
    const/4 p2, 0x2

    iput p2, p0, Lcom/android/server/am/ActivityManagerConstants;->POWER_CHECK_MAX_CPU_4:I
    ...
    iput p2, p0, Lcom/android/server/am/ActivityManagerConstants;->SERVICE_RESTART_DURATION_FACTOR:I
    ...
    iput-boolean p2, p0, Lcom/android/server/am/ActivityManagerConstants;->FLAG_PROCESS_START_ASYNC:Z
    ...
    iput-object p2, p0, Lcom/android/server/am/ActivityManagerConstants;->mParser:Landroid/util/KeyValueListParser;

    .line 226
    const/4 p2, -0x1

    iput p2, p0, Lcom/android/server/am/ActivityManagerConstants;->mOverrideMaxCachedProcesses:I
...
.method public static computeTrimCachedApps(II)I
    ...
    .line 308
    sget p0, Lcom/android/server/am/ActivityManagerConstants;->TRIM_CACHE_PERCENT:I
...
.method private updateConstants()V
    ...
    invoke-virtual {v0, v2, v7}, Landroid/util/KeyValueListParser;->getInt(Ljava/lang/String;I)I
    ...
    iput-wide v9, p0, Lcom/android/server/am/ActivityManagerConstants;->SERVICE_USAGE_INTERACTION_TIME:J
    ...
    iput-wide v9, p0, Lcom/android/server/am/ActivityManagerConstants;->USAGE_STATS_INTERACTION_INTERVAL:J
    ...
    iput-wide v5, p0, Lcom/android/server/am/ActivityManagerConstants;->BG_START_TIMEOUT:J
    ...
    invoke-virtual {v0, v2, v5}, Landroid/util/KeyValueListParser;->getInt(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v2, v5}, Landroid/util/KeyValueListParser;->getBoolean(Ljava/lang/String;Z)Z
...
.method dump(Ljava/io/PrintWriter;)V
    ...
    const-string v0, "max_cached_processes"
