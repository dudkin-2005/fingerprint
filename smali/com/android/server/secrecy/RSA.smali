...
.method public static decrypt(Ljava/security/PublicKey;[B)[B
    ...
    :try_end_f
    .catch Ljava/security/InvalidKeyException; {:try_start_1 .. :try_end_f} :catch_11
    .catch Ljavax/crypto/IllegalBlockSizeException; {:try_start_1 .. :try_end_f} :catch_11
    .catch Ljavax/crypto/BadPaddingException; {:try_start_1 .. :try_end_f} :catch_11
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_1 .. :try_end_f} :catch_11
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_1 .. :try_end_f} :catch_11
...
.method static initRsaKey()V
    ...
    :try_end_33
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_1e .. :try_end_33} :catch_34
    .catch Ljava/security/spec/InvalidKeySpecException; {:try_start_1e .. :try_end_33} :catch_34
    ...
    :try_end_4d
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_38 .. :try_end_4d} :catch_4e
    .catch Ljava/security/spec/InvalidKeySpecException; {:try_start_38 .. :try_end_4d} :catch_4e
...
.method static initRsaPrivateKey(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/security/PrivateKey;
    ...
    move-result-object v3
    :try_end_10
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_6 .. :try_end_10} :catch_12
    .catch Ljava/security/spec/InvalidKeySpecException; {:try_start_6 .. :try_end_10} :catch_12
...
.method public static shaDigest(Ljava/lang/String;)[B
    ...
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_1 .. :try_end_15} :catch_17
