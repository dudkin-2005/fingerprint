...
.method public onResult(Landroid/os/Bundle;)V
    ...
    .line 3392
    invoke-virtual {p0, v2, v1}, Lcom/android/server/accounts/AccountManagerService$StartAccountSession;->checkKeyIntent(ILandroid/content/Intent;)Z
    ...
    invoke-virtual {p0, v0, p1}, Lcom/android/server/accounts/AccountManagerService$StartAccountSession;->onError(ILjava/lang/String;)V
    ...
    invoke-static {p1, v2, v0, v1}, Lcom/android/server/accounts/AccountManagerService;->access$2400(Lcom/android/server/accounts/AccountManagerService;Landroid/accounts/IAccountManagerResponse;ILjava/lang/String;)V
    ...
    .line 3423
    iget-object v0, p0, Lcom/android/server/accounts/AccountManagerService$StartAccountSession;->this$0:Lcom/android/server/accounts/AccountManagerService;
    ...
    .line 3423
    invoke-static {v0, v2, v1, p1}, Lcom/android/server/accounts/AccountManagerService;->access$2400(Lcom/android/server/accounts/AccountManagerService;Landroid/accounts/IAccountManagerResponse;ILjava/lang/String;)V
    ...
    .line 3429
    :cond_6
    iget-boolean v1, p0, Lcom/android/server/accounts/AccountManagerService$StartAccountSession;->mIsPasswordForwardingAllowed:Z
    ...
    iget-object v4, p0, Lcom/android/server/accounts/AccountManagerService$StartAccountSession;->mAccountType:Ljava/lang/String;
    ...
    const-string v4, "Account type in session bundle doesn\'t match request."
    ...
    .line 3459
    invoke-virtual {v3, v1}, Lcom/android/server/accounts/CryptoHelper;->encryptBundle(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    const-string v3, "Failed to encrypt session bundle!"
    ...
    const-string v1, "failed to encrypt session bundle"
    ...
    invoke-static {v0, v2, p1}, Lcom/android/server/accounts/AccountManagerService;->access$2500(Lcom/android/server/accounts/AccountManagerService;Landroid/accounts/IAccountManagerResponse;Landroid/os/Bundle;)V
